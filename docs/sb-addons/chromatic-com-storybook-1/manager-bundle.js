try {
	(() => {
		...
		var a = __REACT__,
			{
				...
				StrictMode: E8,
				Suspense: k8,
				__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: w8,
				act: C8,
				cloneElement: Jr,
				createContext: $e,
				createElement: C,
		...
		var j8 = __STORYBOOK_TYPES__,
			{
				Addon_TypesEnum: Un,
				CHANGE_DETECTION_STATUS_TYPE_ID: z8,
				CoreWebpackCompiler: U8,
				Feature: $8,
				NON_AGGREGATED_STATUS_TYPE_IDS: W8,
				REVIEW_EVENTS: q8,
				REVIEW_NAMESPACE: G8,
				REVIEW_STATUS_TYPE_ID: Y8,
				SupportedBuilder: K8,
				SupportedFramework: Q8,
				SupportedLanguage: J8,
				SupportedRenderer: X8,
			} = __STORYBOOK_TYPES__;
		var rg = __STORYBOOK_API__,
			{
				ActiveTabs: ig,
				Consumer: lg,
				ManagerContext: og,
				Provider: sg,
				RequestResponseError: dg,
				Tag: cg,
				addons: dn,
				combineParameters: ug,
				controlOrMetaKey: mg,
				controlOrMetaSymbol: pg,
				eventMatchesShortcut: hg,
				eventToShortcut: fg,
				experimental_MockUniversalStore: gg,
				experimental_UniversalStore: vg,
				experimental_getStatusStore: Pa,
				experimental_getTestProviderStore: ql,
				experimental_requestResponse: yg,
				experimental_useStatusStore: Gl,
				experimental_useTestProviderStore: Yl,
				experimental_useUniversalStore: bg,
				getService: Eg,
				internal_checklistStore: kg,
				internal_fullStatusStore: wg,
				internal_fullTestProviderStore: Cg,
				internal_universalChecklistStore: Sg,
				internal_universalStatusStore: xg,
				internal_universalTestProviderStore: Ag,
				isMacLike: Lg,
				isShortcutTaken: Ng,
				keyToSymbol: Fg,
				merge: Tg,
				...
				registerService: Ig,
				shortcutMatchesShortcut: Og,
				shortcutToAriaKeyshortcuts: Zg,
				shortcutToHumanString: Rg,
				types: Bg,
				useAddonState: Kl,
				useArgTypes: Pg,
				useArgs: Vg,
		...
		var Gg = __STORYBOOK_COMPONENTS__,
			{
				...
				StatelessTab: O9,
				StatelessTabList: Z9,
				StatelessTabPanel: R9,
				StatelessTabsView: B9,
				StorybookIcon: P9,
				StorybookLogo: V9,
				...
				codeCommon: rv,
				components: iv,
				convertToReactAriaPlacement: lv,
				createCopyToClipboardFunction: ov,
				getStoryHref: sv,
				interleaveSeparators: dv,
				nameSpaceClassNames: cv,
				resetComponents: uv,
				useCopyButton: mv,
				useTabsState: pv,
				withReset: hv,
			} = __STORYBOOK_COMPONENTS__;
		var bv = __STORYBOOK_THEMING__,
			{
				CacheProvider: Ev,
				ClassNames: kv,
				Global: wv,
		...
		var qn = __REACT_DOM__,
			{
				...
				unstable_batchedUpdates: ey,
				unstable_renderSubtreeIntoContainer: so,
				version: ty,
			} = __REACT_DOM__;
		var Od =
			...
			co = 'Bc2PgW_p',
			Zd = 'Bc2PgW_c',
			uo = ['#FFC700', '#FF0000', '#2E3191', '#41BBC7'],
			mo = 3500,
			po = 0.5,
			ho = 150,
			fo = 'mix',
		...
		function Rd(e, t = {}) {
			...
			let p = [],
				f = [],
				h = () => Gn(ot() * (Dd - 1)),
				y = (v, E) => o !== 'rectangles' && (v === 'circles' || jd(E));
			function w(v, E) {
				let S = h(),
					L = y(o, S),
					N = (fe, ke) => v.style.setProperty(fe, ke + '');
				(N(
					'--xlp',
					ii(Ha(So(E, 90) - 180), 0, 180, -u / 2, u / 2) + 'px',
				),
					N('--dc', r - Gn(1e3 * ot()) + 'ms'));
				let G = ot() < Pd ? mn(ot() * Vd, 2) : 0;
				(N('--x1', G),
					N('--x2', -1 * G),
					N('--x3', G),
					N(
						'--x4',
						mn(Ha(ii(Ha(So(E, 90) - 180), 0, 180, -1, 1)), 4),
					),
					N('--y1', mn(ot() * wo, 4)),
					N('--y2', mn(ot() * i * (Ao() ? 1 : -1), 4)),
					N('--y3', wo),
					N('--y4', mn(Hd(ii(Ha(E - 180), 0, 180, i, -i), 0), 4)),
					N('--w', (L ? s : Gn(4 * ot()) + s / 2) + 'px'),
					N('--h', (L ? s : Gn(2 * ot()) + s) + 'px'));
				let te = S.toString(2).padStart(3, '0').split('');
				(N('--hr', te.map((fe) => +fe / 2 + '').join(' ')),
					N('--r', te.join(' ')),
					N('--rd', mn(ot() * (Bd - ko) + ko) + 'ms'),
					N('--br', L ? '50%' : 0));
			}
			let b;
			function g() {
				((e.innerHTML = ''),
					...
					(f = (function (v, E = [], S) {
						...
						for (let { color: N } of E) {
							let G = ai('div');
							((G.className = `${co} ${S}`),
								G.style.setProperty('--bgc', N));
							let te = ai('div');
							(ri(G, te), ri(v, G), L.push(G));
						}
						return L;
					})(e, p, d)));
				for (let [v, E] of xo(f)) w(E, p[+v].degree);
				b = setTimeout(() => {
					c && (e.innerHTML = '');
				}, r);
			}
			return (
				...
				{
					update(v) {
						let E = v.particleCount ?? ho,
							S = v.particleShape ?? fo,
							L = v.particleSize ?? go,
							N = v.particleClass ?? vo,
							G = v.colors ?? uo,
							te = v.stageHeight ?? bo,
							fe = v.duration ?? mo,
							ke = v.force ?? po,
							je = v.stageWidth ?? Eo,
							Ae = v.destroyAfterDone ?? yo;
						p = Co(E, G);
						let ye = !1;
						if (E === l) {
							f = Array.from(e.querySelectorAll(`.${co}`));
							for (let [Le, { color: Vt }] of xo(p)) {
								let Ke = f[+Le];
								(JSON.stringify(n) !== JSON.stringify(G) &&
									Ke.style.setProperty('--bgc', Vt),
									S !== o &&
									...
									N !== d &&
										(d && Ke.classList.remove(d),
										N && Ke.classList.add(N)));
							}
						} else ye = !0;
						(c && !Ae && clearTimeout(b),
		...
		var ko = 200,
			...
			Gn = Math.round,
			Hd = Math.max,
			ai = (e) => document.createElement(e),
			ri = (e, t) => e.appendChild(t),
			Co = (e, t) =>
				Array.from({ length: e }, (n, r) => ({
					color: t[r % t.length],
					degree: (360 * r) / e,
				})),
			mn = (e, t = 2) => Gn((e + Number.EPSILON) * 10 ** t) / 10 ** t,
			ii = (e, t, n, r, i) => ((e - t) * (i - r)) / (n - t) + r,
			So = (e, t) => (e + t > 360 ? e + t - 360 : e + t),
			Ao = () => ot() > 0.5,
			xo = Object.entries,
			Dd = 6,
			jd = (e) => e !== 1 && Ao();
			...
			return (
				Q(() => {
					if (typeof window < 'u' && n.current) {
						if (r.current)
							return (r.current.update(t), r.current.destroy);
						r.current = Rd(n.current, t);
					}
				}, [t]),
		...
		var Ud = Object.create,
				...
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let i of Wd(t))
						!Gd.call(e, i) &&
							...
							sl(e, i, {
								get: () => t[i],
								enumerable: !(r = $d(t, i)) || r.enumerable,
							});
				return e;
			},
			bt = (e, t, n) => (
				...
				Qd(
					t || !e || !e.__esModule
						? sl(n, 'default', { value: e, enumerable: !0 })
						: n,
					e,
				)
			),
			dl = Rt((e, t) => {
				(function (n, r) {
					...
					function c(y, w) {
						return y.replace(/\$(\d{1,2})/g, function (b, g) {
							return w[g] || '';
						});
					}
					function m(y, w) {
						return y.replace(w[0], function (b, g) {
							var v = c(w[1], arguments);
							return d(b === '' ? y[g - 1] : b, v);
						});
					}
					function u(y, w, b) {
					...
					function h(y, w, b) {
						var g = w === 1 ? h.singular(y) : h.plural(y);
						return (b ? w + ' ' : '') + g;
					}
					return (
						(h.plural = p(o, l, n)),
				...
				function o(c) {
					return function (m, u, p, f) {
						...
						var h = l(),
							...
							g = !1;
						return (
							y === u ? f(n, m[c]) : requestAnimationFrame(E),
							v
						);
						function v() {
							g = !0;
			...
			Xd = Rt((e, t) => {
				(function (n, r) {
					...
					function n(i) {
						var l = getComputedStyle(i, null).getPropertyValue(
							'overflow',
						);
						return (
							l.indexOf('scroll') > -1 || l.indexOf('auto') > -1
						);
					}
					function r(i) {
						if (
			...
			cl = Rt((e, t) => {
				...
				function m(v, E, S) {
					return v.concat(E).map(function (L) {
						return c(L, S);
					});
				}
				function u(v, E) {
				...
				function w(v, E, S) {
					...
					return (
						S.isMergeableObject(v) &&
							f(v).forEach(function (N) {
								L[N] = c(v[N], S);
							}),
						f(E).forEach(function (N) {
							y(v, N) ||
								(h(v, N) && S.isMergeableObject(E[N])
									? (L[N] = u(N, S)(v[N], E[N], S))
									: (L[N] = c(E[N], S)));
						}),
						L
			...
			rc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			ic = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			lc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			oc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			sc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			dc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			cc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			uc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			mc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			pc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			hc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			fc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			gc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Zr = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			vc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			ul = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			yc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			bc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Qt = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Ec = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			kc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			ps = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			wc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			xc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			hs = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Ac = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Nc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			Tc = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			_c = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
				C(
					'svg',
					{
						width: t,
			...
			ml = 'chromaui:addon-visual-tests',
			j = 'chromaui/addon-visual-tests',
			En = `${j}/panel`,
			Mi = `${j}/test-provider`,
			pl = `${j}/configInfo`,
			Fo = `${j}/configInfoDismissed`,
			hl = `${j}/gitInfo`,
			gs = `${j}/gitInfoError`,
			vs = `${j}/projectInfo`,
			ys = `${j}/isOffline`,
			Zc = `${j}/startBuild`,
			Rc = `${j}/stopBuild`,
			bs = `${j}/localBuildProgress`,
			Bc = `${j}/startShare`,
			Pc = `${j}/cancelShare`,
			fl = `${j}/shareProgress`,
			Vc = `${j}/selectedModeName`,
			Hc = `${j}/selectedBrowserId`,
			Es = `${j}/telemetry`,
			To = `${j}/enableFilter`,
			ks = `${j}/removeAddon`,
			Dc = 'chromatic',
			la = 'highlightIgnored',
			jc = `${j}/highlightIgnored/count`,
			zc = `${j}/highlightIgnored/select`,
			Uc = ['[data-chromatic="ignore"]', '[class~="chromatic-ignore"]'],
			$c = `${j}/ChannelFetch/aborted`,
			Wc = `${j}ChannelFetch/request`,
			qc = `${j}ChannelFetch/response`,
			Gc = {
				autoAcceptChanges: !1,
				exitOnceUploaded: !1,
				exitZeroOnChanges: !0,
			...
			ws = 'https://www.chromatic.com/docs/visual-tests-addon',
			Yc = ({ enabled: e, ignoreCount: t, locked: n, onToggle: r }) =>
				t === 0
					? null
					: a.createElement(
							to,
							{
								...
								active: e,
								ariaLabel: n
									? `Highlights ${e ? 'enabled' : 'disabled'} by story globals`
									: `${e ? 'Hide' : 'Show'} ignored areas`,
								padding: 'small',
								variant: 'ghost',
								disabled: n,
								onClick: r,
							},
							a.createElement(ic, null),
							t,
						),
			Kc = () => {
				let [e, t, n] = ti(),
			...
			Cs = $e(null),
			Qc = ({ children: e, value: t }) =>
				a.createElement(Cs.Provider, { value: t }, e),
			gl = () => Et(Cs, 'AuthState'),
			Jc = {
			...
			vl = ({ icon: e, ...t }) =>
				a.createElement(
					...
					a.createElement(a.Fragment, null, Jc[e]),
				);
		function Pe() {
			return (
				(Pe = Object.assign
		...
		function a5(e, t, n) {
			...
			return (n && ca(i, n.prototype), i);
		}
		function Ii(e) {
			var t = typeof Map == 'function' ? new Map() : void 0;
			return (
				(Ii = function (n) {
					if (n === null || !n5(n)) return n;
					...
					function r() {
						return a5(n, arguments, _i(this).constructor);
					}
					return (
		...
		function ua(e, t, n, r) {
			if ((r === void 0 && (r = r5), t === 0)) return r(n, n, n);
		...
		function kn(e) {
			...
			var l = c5.exec(t.substring(0, 50));
			if (l)
				return {
					red: parseInt('' + l[1], 10),
			...
			var p = m5.exec(t.substring(0, 50));
			if (p) {
		...
		function g5(e, t, n) {
			...
			if (typeof e == 'object' && t === void 0 && n === void 0)
				return sr(e.hue, e.saturation, e.lightness);
			throw new ut(1);
		}
		function v5(e, t, n, r) {
			if (
			...
			if (
				...
				return e.alpha >= 1
					...
					: 'rgba(' +
							ua(e.hue, e.saturation, e.lightness) +
							',' +
							e.alpha +
							')';
			throw new ut(2);
		...
		function w5(e, t) {
			...
			var n = Bt(t);
			return Pt(Pe({}, n, { hue: n.hue + parseFloat(e) }));
		}
		He(w5);
		function Zn(e, t, n) {
		...
		function C5(e, t) {
			...
			var n = Bt(t);
			return Pt(
				Pe({}, n, { lightness: Zn(0, 1, n.lightness - parseFloat(e)) }),
			);
		}
		var S5 = He(C5),
			Ri = S5;
		function x5(e, t) {
			...
			return Pt(
				Pe({}, n, {
					saturation: Zn(0, 1, n.saturation - parseFloat(e)),
				}),
			);
		}
		He(x5);
		...
		function N5(e, t, n) {
			...
			var r = kn(t),
				...
				f = {
					...
					alpha:
						i.alpha * parseFloat(e) + o.alpha * (1 - parseFloat(e)),
				};
			return wn(f);
		}
		var F5 = He(N5),
		...
		function T5(e, t) {
			...
			var n = kn(t),
				...
				i = Pe({}, n, {
					alpha: Zn(0, 1, (r * 100 + parseFloat(e) * 100) / 100),
				});
			return wn(i);
		}
		He(T5);
		...
		function _5(e, t) {
			return t === 'transparent'
				? t
				: Pt(Pe({}, Bt(t), { hue: parseFloat(e) }));
		}
		He(_5);
		function I5(e, t) {
			return t === 'transparent'
				? t
				: Pt(Pe({}, Bt(t), { lightness: parseFloat(e) }));
		}
		He(I5);
		function O5(e, t) {
			return t === 'transparent'
				? t
				: Pt(Pe({}, Bt(t), { saturation: parseFloat(e) }));
		}
		He(O5);
		function Z5(e, t) {
			return t === 'transparent'
				? t
				: Ls(parseFloat(e), 'rgb(0, 0, 0)', t);
		}
		He(Z5);
		function R5(e, t) {
			return t === 'transparent'
			...
			var n = kn(t),
				...
				i = Pe({}, n, {
					alpha: Zn(
						0,
						1,
						+(r * 100 - parseFloat(e) * 100).toFixed(2) / 100,
					),
				});
			return wn(i);
		}
		...
		ce({
			...
			[`@media (min-width: ${Da * 1}px)`]: { margin: `0 ${ja * 1}%` },
			[`@media (min-width: ${Da * 2}px)`]: { margin: `0 ${ja * 2}%` },
			[`@media (min-width: ${Da * 3}px)`]: { margin: `0 ${ja * 3}%` },
			[`@media (min-width: ${Da * 4}px)`]: { margin: `0 ${ja * 4}%` },
		});
		ce({
			...
			'&:hover, &.__hover': {
				borderColor: `${wn(D.secondary, 0.5)}`,
				transform: 'translate3d(0, -3px, 0)',
				boxShadow: 'rgba(0, 0, 0, 0.08) 0 3px 10px 0',
			},
			'&:active, &.__active': {
				borderColor: `${wn(D.secondary, 1)}`,
				transform: 'translate3d(0, 0, 0)',
			},
		});
		...
		var Ns = Tt({
			...
			Fs = Tt({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } });
		Tt({
		...
		var V5 = ce({
			...
			j5 = k.div(
				...
				(e) =>
					({
						...
						large: {
							fontSize: `${H.size.s3}px`,
							lineHeight: `${Wt.large}px`,
						},
					})[e.size || 'medium'],
			),
			z5 = ({
			...
			$5 = k.a(
				{
					...
					'&:hover, &:focus-visible': {
						...
						color: Ri(0.07, D.secondary),
					},
					'&:active': {
						transform: 'translateY(0)',
						color: Ri(0.1, D.secondary),
					},
					svg: {
						display: 'inline-block',
						height: '1em',
				...
				(e) => ({
					...(e.secondary && {
						color:
							e.theme.base === 'light' ? D.mediumdark : D.medium,
						'&:hover': {
							color: e.theme.base === 'light' ? D.dark : D.light,
						},
						'&:active': {
							color:
								e.theme.base === 'light' ? D.darker : D.lighter,
						},
					}),
					...(e.tertiary && {
						color: D.dark,
			...
			Ts = Y(
				(
					...
					t
						? a.createElement(q5, { ...o, ref: s })
						: n
							? a.createElement(n, { ...o, ref: s })
							: a.createElement(W5, { ...o, ref: s }),
			);
		Ts.displayName = 'LinkComponentPicker';
		var xe = Y(({ children: e, withArrow: t, ...n }, r) => {
			let i = a.createElement(
				...
				a.createElement(
					...
					{ withArrow: !!t },
					e,
					t && a.createElement(vl, { icon: 'arrowright' }),
				),
			);
			return a.createElement($5, { as: Ts, ref: r, ...n }, i);
		});
		xe.displayName = 'Link';
		xe.defaultProps = {
			withArrow: !1,
		...
		var G5 = k.label((e) => ({
			...
			J5 = k.div((e) => ({
				...
				'.sbds-input-el': {
					...
					...(e.error && {
						...
						'&:focus': {
							boxShadow: `${D.red} 0 0 0 1px inset !important`,
						},
					}),
				},
				'> svg': {
			...
			_o = ({ error: e, value: t, lastErrorValue: n }) => {
			...
			Ms = Y(
				(
					...
					let [g, v] = be(
							_o({ error: r, value: y, lastErrorValue: d }),
						),
						E = `${e}-error`;
					Q(() => {
						v(_o({ error: r, value: y, lastErrorValue: d }));
					}, [y, r, d]);
					let S = a.createElement(K5, {
		...
		Ms.displayName = 'PureInput';
		var _s = Y(({ type: e, startFocused: t, ...n }, r) => {
			let [i, l] = be(e),
				o = z(
					(m) => {
						if (
		...
		var au = k.div(
			...
			cu = k(({ active: e, activeColor: t, isLoading: n, ...r }) =>
				a.createElement('a', { ...r }),
			)(bl),
			uu = k.span(bl),
			mu = ru((e) =>
			...
			Qe = ({
				...
				return a.createElement(
					Io,
					null,
					a.createElement(s ? cu : uu, { activeColor: c, ...d }, m),
				);
			},
			J = {};
		Kd(J, {
		...
		var cr = (e) => {
				let { data: t, path: n, errorMaps: r, issueData: i } = e,
					...
					o = { ...i, path: l };
				if (i.message !== void 0)
					return { ...i, path: l, message: i.message };
				let s = '',
					d = r
						.filter((c) => !!c)
						.slice()
		...
		var ee = class {
			...
			vu = /^c[^\s-]{8,}$/i,
			yu = /^[0-9a-z]+$/,
			bu = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
			Eu =
				/^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
			ku = /^[a-z0-9_-]{21}$/i,
			wu = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
			Cu =
				/^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
			Su =
				/^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
			xu = '^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$',
			ui,
			Au =
		...
		var Sn = class extends ee {
			_parse(e) {
				...
				if (Number.isNaN(e.data.getTime())) {
					let r = this._getOrReturnCtx(e);
					return (T(r, { code: x.invalid_date }), U);
				}
				let t = new Te(),
					n;
				for (let r of this._def.checks)
		...
		ur.create = (e) => new ur({ typeName: $.ZodSymbol, ...X(e) });
		...
		ha.create = (e) => new ha({ typeName: $.ZodUndefined, ...X(e) });
		...
		fa.create = (e) => new fa({ typeName: $.ZodNull, ...X(e) });
		var xn = class extends ee {
			constructor() {
		...
		xn.create = (e) => new xn({ typeName: $.ZodAny, ...X(e) });
		...
		Yt.create = (e) => new Yt({ typeName: $.ZodUnknown, ...X(e) });
		...
		At.create = (e) => new At({ typeName: $.ZodNever, ...X(e) });
		...
		mr.create = (e) => new mr({ typeName: $.ZodVoid, ...X(e) });
		...
		function fn(e) {
			if (e instanceof ve) {
				...
				return e instanceof ft
					? new ft({ ...e._def, type: fn(e.element) })
					: e instanceof gt
						? gt.create(fn(e.unwrap()))
						: e instanceof Ot
							? Ot.create(fn(e.unwrap()))
							: e instanceof Lt
								? Lt.create(e.items.map((t) => fn(t)))
								: e;
		}
		var ve = class extends ee {
			...
			_parse(e) {
				...
				for (let s of i) {
					...
					o.push({
						...
						value: d._parse(new yt(n, c, n.path, s)),
				...
				if (this._def.catchall instanceof At) {
					...
					if (s === 'passthrough')
						...
						l.length > 0 &&
							(T(n, { code: x.unrecognized_keys, keys: l }),
							t.dirty());
					else if (s !== 'strip')
						throw new Error(
					...
					for (let d of l) {
						...
						o.push({
							key: { status: 'valid', value: d },
							value: s._parse(new yt(n, c, n.path, d)),
				...
				return n.common.async
					? Promise.resolve()
							...
							.then((s) => Te.mergeObjectSync(t, s))
					: Te.mergeObjectSync(t, o);
			}
			get shape() {
			...
			pick(e) {
				let t = {};
				for (let n of le.objectKeys(e))
					e[n] && this.shape[n] && (t[n] = this.shape[n]);
				return new ve({ ...this._def, shape: () => t });
			}
			omit(e) {
				let t = {};
				for (let n of le.objectKeys(this.shape))
		...
		var ga = class extends ee {
			_parse(e) {
				...
				function r(i) {
					...
					return (T(t, { code: x.invalid_union, unionErrors: l }), U);
				}
				if (t.common.async)
					return Promise.all(
						n.map(async (i) => {
					...
					).then(r);
				{
					...
					return (T(t, { code: x.invalid_union, unionErrors: o }), U);
				}
			}
			get options() {
		...
		ga.create = (e, t) =>
			new ga({ options: e, typeName: $.ZodUnion, ...X(t) });
		var Mt = (e) =>
				e instanceof ya
					? Mt(e.schema)
					: e instanceof Xe
		...
		var va = class extends ee {
			_parse(e) {
				let { status: t, ctx: n } = this._processInputParams(e),
					r = (i, l) => {
						if (Vi(i) || Vi(l)) return U;
						let o = Di(i.value, l.value);
						return o.valid
							? ((Hi(i) || Hi(l)) && t.dirty(),
								{ status: t.value, value: o.data })
							: (T(n, { code: x.invalid_intersection_types }), U);
					};
				return n.common.async
					? Promise.all([
		...
		va.create = (e, t, n) =>
			new va({ left: e, right: t, typeName: $.ZodIntersection, ...X(n) });
		var Lt = class extends ee {
			_parse(e) {
				...
				let r = [...n.data]
					...
					.filter((i) => !!i);
				return n.common.async
					? Promise.all(r).then((i) => Te.mergeArray(t, i))
					: Te.mergeArray(t, r);
			}
			get items() {
			...
			rest(e) {
				return new Lt({ ...this._def, rest: e });
			}
		};
		Lt.create = (e, t) => {
			if (!Array.isArray(e))
		...
		var pr = class extends ee {
				...
				_parse(e) {
					...
					return n.common.async
						? Te.mergeObjectAsync(t, r)
						: Te.mergeObjectSync(t, r);
				}
				get element() {
					return this._def.valueType;
				}
				...
				_parse(e) {
					...
					let r = this._def.keyType,
						...
						l = [...n.data.entries()].map(([o, s], d) => ({
							key: r._parse(new yt(n, o, n.path, [d, 'key'])),
							value: i._parse(new yt(n, s, n.path, [d, 'value'])),
						}));
					if (n.common.async) {
						let o = new Map();
		...
		hr.create = (e, t, n) =>
			new hr({ valueType: t, keyType: e, typeName: $.ZodMap, ...X(n) });
		...
		var da = class extends ee {
				...
				args(...e) {
					return new da({
						...this._def,
						args: Lt.create(e).rest(Yt.create()),
					});
				}
				returns(e) {
					return new da({ ...this._def, returns: e });
				}
				implement(e) {
					return this.parse(e);
				}
				...
				static create(e, t, n) {
					return new da({
						args: e || Lt.create([]).rest(Yt.create()),
						returns: t || Yt.create(),
		...
		ya.create = (e, t) =>
			new ya({ getter: e, typeName: $.ZodLazy, ...X(t) });
		var ba = class extends ee {
			_parse(e) {
		...
		ba.create = (e, t) =>
			new ba({ value: e, typeName: $.ZodLiteral, ...X(t) });
		function Bs(e, t) {
			return new tn({ values: e, typeName: $.ZodEnum, ...X(t) });
		}
		var tn = class extends ee {
			_parse(e) {
			...
			extract(e, t = this._def) {
				return tn.create(e, { ...this._def, ...t });
			}
		...
		var Ea = class extends ee {
			_parse(e) {
				...
				if (
					(this._cache ||
						(this._cache = new Set(
							le.getValidEnumValues(this._def.values),
						)),
					!this._cache.has(e.data))
				) {
					let r = le.objectValues(t);
		...
		Ea.create = (e, t) =>
			new Ea({ values: e, typeName: $.ZodNativeEnum, ...X(t) });
		var Ln = class extends ee {
			unwrap() {
				return this._def.type;
			}
			_parse(e) {
		...
		Ln.create = (e, t) =>
			new Ln({ type: e, typeName: $.ZodPromise, ...X(t) });
		...
		Xe.create = (e, t, n) =>
			new Xe({ schema: e, typeName: $.ZodEffects, effect: t, ...X(n) });
		...
		gt.create = (e, t) =>
			new gt({ innerType: e, typeName: $.ZodOptional, ...X(t) });
		...
		Ot.create = (e, t) =>
			new Ot({ innerType: e, typeName: $.ZodNullable, ...X(t) });
		var ka = class extends ee {
			_parse(e) {
				let { ctx: t } = this._processInputParams(e),
					n = t.data;
				return (
					t.parsedType === M.undefined &&
		...
		fr.create = (e) => new fr({ typeName: $.ZodNaN, ...X(e) });
		var Pu = Symbol('zod_brand'),
			kl = class extends ee {
				_parse(e) {
					let { ctx: t } = this._processInputParams(e),
						n = t.data;
			...
			Rr = class extends ee {
				...
				static create(e, t) {
					return new Rr({ in: e, out: t, typeName: $.ZodPipeline });
				}
			},
			Ca = class extends ee {
				_parse(e) {
					let t = this._def.innerType._parse(e),
						n = (r) => (
							Jt(r) && (r.value = Object.freeze(r.value)),
							r
						);
		...
		Ca.create = (e, t) =>
			new Ca({ innerType: e, typeName: $.ZodReadonly, ...X(t) });
		function Zo(e, t) {
			let n =
				typeof e == 'function'
					? e(t)
		...
		var Hu = (e, t = { message: `Input not instance of ${e.name}` }) =>
				Ps((n) => n instanceof e, t),
			Vs = mt.create,
			Hs = Xt.create,
			Du = fr.create,
			ju = en.create,
			...
			k2 = U,
			{
				CHROMATIC_INDEX_URL: w2,
				CHROMATIC_BASE_URL: gr = w2 || 'https://www.chromatic.com',
				CHROMATIC_API_URL: C2 = `${gr}/api`,
			} = Ue,
			S2 =
				(typeof window < 'u' && window.__CHROMATIC_STORYBOOK_ID__) ||
				'unscoped',
			Yn = `${j}/access-token/${gr}/${S2}`;
		function oa(e) {
			function t(L, N) {
				return (L >>> N) | (L << (32 - N));
			}
			...
			for (
				s[s.length] = (d / l) | 0, s[s.length] = d, r = 0;
				r < s.length;
			) {
		...
		var js = /^[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$/,
			wl = (e) =>
				e
					.toLowerCase()
					.replace(/[^a-z0-9-]/g, '')
			...
			x2 = J.object({
				version: J.literal(2),
				accessToken: J.string().min(1),
				refreshToken: J.string().min(1),
				subdomain: J.string().regex(js).optional(),
				sessionId: J.string().min(1),
			}),
			A2 = J.object({
				access_token: J.string().min(1),
				refresh_token: J.string().min(1).optional(),
				error: J.string().optional(),
				error_description: J.string().optional(),
			}),
			ji = class extends Error {
				constructor(e) {
					(super(e), (this.name = 'TerminalAuthError'));
				}
			},
			L2 = (e) => e === 400 || e === 401 || e === 403,
			N2 = (e) => String.fromCharCode(...e),
			F2 = (e) => window.btoa(Array.isArray(e) ? N2(e) : e),
			Us = (e) =>
				F2(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
			T2 = (e) =>
				Array.from(e.match(/.{1,2}/g) ?? [], (t) => parseInt(t, 16)),
			Bo = (e) => {
				let t = new Uint8Array(e);
				return (window.crypto.getRandomValues(t), Us(Array.from(t)));
			},
			Cl = (e) => new URLSearchParams(e).toString(),
			$s = (e) => {
				if (!e) return gr;
				if (!js.test(e)) throw new Error('Invalid Chromatic subdomain');
				let t = new URL(gr);
				return (
					t.hostname.startsWith('www.') &&
						(t.hostname = `${e}.${t.hostname.slice(4)}`),
					t.origin
				);
			},
			Ws = (e) => `${$s(e)}/token`,
			qs = async (e) => {
				let t = Bo(32),
					...
					s = `${l}/authorize?${Cl({ client_id: ml, response_type: 'code', code_challenge: i, code_challenge_method: 'S256', redirect_uri: o, state: t, scope: 'user:read account:read project:read build:read build:write build:create' })}`;
				return {
					redirectUri: o,
					codeVerifier: n,
					state: t,
			...
			Gs = async (e, t) => {
				...
				try {
					...
					throw e.ok ? new Error(t) : new Error(`${t} (${e.status})`);
				}
				if (n?.error === 'authorization_pending')
					throw new Error(
				...
				let r = A2.safeParse(n);
				if (r.success) return r.data;
				let i = n?.error_description || n?.error || t;
				throw new Error(i);
			},
			M2 = async ({
				codeVerifier: e,
				...
				let l = await fetch(Ws(r), {
						method: 'POST',
						headers: {
							'Content-Type':
								'application/x-www-form-urlencoded;charset=UTF-8',
							'X-Chromatic-Session-ID': n,
						},
						body: Cl({
							client_id: ml,
					...
					o = await Gs(l, 'Token exchange failed');
				if (!o.refresh_token)
					throw new Error(
						'Token exchange failed: missing refresh token',
					);
				return {
					version: 2,
			...
			_2 = async ({
				...
				if (!i.ok) {
					let o = `Token refresh failed (${i.status})`;
					throw L2(i.status) ? new ji(o) : new Error(o);
				}
				let l = await Gs(i, 'Token refresh failed');
				return {
					version: 2,
					accessToken: l.access_token,
					refreshToken: l.refresh_token ?? t,
					sessionId: n,
					...(e ? { subdomain: e } : {}),
				};
			},
			Br = $e(null),
			I2 = ({ children: e, value: t }) =>
				a.createElement(Br.Provider, { value: t }, e),
			De = (e, t) => {
				let n = Et(Br, 'Telemetry');
				Q(() => n({ location: e, screen: t }), [e, t, n]);
			};
		function Ys() {
			let e = Ft(),
			...
			return z(
				(l, o) => {
					t({
						...
						icon: a.createElement(Qt, { color: cn.negative }),
						onClick: i,
					});
				},
				[t, i],
		...
		function Se(e, t) {
			let n = z(() => {
					try {
						let s = sessionStorage.getItem(`${j}/state/${e}`);
		...
		function O2(...e) {
			let t = sessionStorage.getItem(`${j}/state`)?.split(';') || [],
				n = e.length ? e : t;
			(n.forEach((r) => sessionStorage.removeItem(`${j}/state/${r}`)),
				e.length
					? sessionStorage.setItem(
							`${j}/state`,
							t.filter((r) => !e.includes(r)).join(';'),
						)
					: sessionStorage.removeItem(`${j}/state`),
				n.forEach((r) => {
					window.dispatchEvent(
						new StorageEvent('session-storage', { key: r }),
					);
				}));
		}
		var Ks = $e(void 0),
			...
			Js = (e) =>
				a.createElement(
					...
					a.createElement(
						'g',
						{
							transform: 'translate(41.666667, 35.714286)',
							fill: '#FFFFFF',
						},
						a.createElement('path', {
			...
			R2 = bt(dl());
		k.div({ display: 'flex', flexDirection: 'column' });
		k.div(({ theme: e }) => ({
			padding: 15,
			lineHeight: '18px',
		...
		k(ms)(Pr);
		k(uc)(Pr);
		var P2 = k(ul)({ marginLeft: 'auto' }),
			V2 = k(V.Button)({ margin: -5, marginLeft: 'auto' }),
			re = k(jt)(
				{
					'&&': {
						display: 'inline-flex',
			...
			Sl = class {
				...
				get(e) {
					return (
						this.state[e] || this.channel.emit(Po, e),
						this.state[e]?.value
					);
				}
				set(e, t) {
		...
		var H2 = {
			...
			D2 = k(V2)({ position: 'absolute', right: 16, top: 10 }),
			j2 = k.div(({ theme: e }) => ({
			...
			z2 = k.div({ margin: '0 auto', maxWidth: 600, width: '100%' }),
			Vo = k.div(({ theme: e }) => ({
				borderBottom: `1px solid ${e.appBorderColor}`,
				marginBottom: 20,
				paddingBottom: 20,
			...
			U2 = k(B2)({ marginBottom: 10 }),
			$2 = k.div({ display: 'flex', flexDirection: 'column', gap: 20 }),
			Ho = k.div(({ theme: e }) => ({
				alignItems: 'center',
			...
			zo = k.div({ marginTop: 10 }),
			W2 = k.div(({ hideBorderRadius: e, theme: t }) => ({
				background:
			...
			q2 = k.div(({ theme: e }) => ({ color: e.color.warningText })),
			Uo = k.div(({ theme: e }) => ({
				color: e.base === 'dark' ? e.color.medium : e.color.dark,
				marginTop: 2,
			})),
			$o = k.div(({ warning: e, theme: t }) => ({
				alignItems: 'center',
				display: 'flex',
				backgroundColor: e
					? t.base === 'dark'
			...
			Xs = { height: 12, margin: 2, verticalAlign: 'top', width: 12 },
			Y2 = k(wc)(Xs),
			K2 = k(gc)(Xs),
			Q2 = ({ onClose: e }) => {
				let { uninstallAddon: t } = Qs(),
					[n] = Ee(pl),
					{
						configuration: r = {},
						problems: i = {},
				...
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(P2, null),
					),
					a.createElement(
						z2,
						null,
						a.createElement(U2, null, 'Configuration'),
						o
							? a.createElement(
									Vo,
									null,
			...
			J2 = {
				toggleDiff: Ua('diffVisible'),
				toggleFocus: Ua('focusVisible'),
				toggleConfig: Ua('configVisible'),
				toggleBaselineImage: Ua('baselineImageVisible'),
			},
			X2 = (e, t) => J2[t.type](e, t.payload),
			t0 = $e(e0),
			n0 = $e(() => {}),
			xl = () => Et(t0, 'Controls'),
			La = () => {
				let e = Et(n0, 'ControlsDispatch');
				return kt(
					() => ({
						toggleDiff: (t) =>
			...
			em = ({ children: e, initialState: t = e0 }) => {
				let [n, r] = ei(X2, t);
				return a.createElement(
					t0.Provider,
					{ value: n },
					a.createElement(n0.Provider, { value: r }, e),
				);
			},
			Vr = () => {
				let { accessToken: e, setAccessToken: t, subdomain: n } = gl(),
					{ toggleConfig: r } = La(),
					[i] = Ee(vs),
					l = Pa(j),
					{ projectId: o } = i || {};
		...
		var tm = k.div(
			...
			Al = k.div(({ grow: e }) => e && { flexGrow: e ? 1 : 'auto' }),
			sa = k.div(
			...
			nm = k(sa)({ alignItems: 'center', height: 40, margin: '0 10px' }),
			Ye = k.div(
				{
					display: 'flex',
					flexDirection: 'column',
			...
			im = ({
				...
				let [i] = Ee(pl),
					...
					[s, d] = be(() => !!localStorage.getItem(Fo)),
					c = z(() => {
						(d(!0), localStorage.setItem(Fo, 'true'));
					}, []),
					m = a.createElement(
						xe,
						{
			...
			qo = k.div(({ hidden: e, interstitial: t, theme: n }) => ({
			...
			he = ({
				...
				footer: t = a.createElement(
					Hr,
					null,
					a.createElement(Ye, { push: !0 }),
					a.createElement(Ye, null, a.createElement(Vr, null)),
				),
				ignoreConfig: n = !1,
				ignoreSuggestions: r = !t,
				interstitial: i = !1,
			}) => {
				let { configVisible: l } = xl(),
					{ toggleConfig: o } = La(),
					s = z(
						(d) => {
							(o(!0),
				...
				return a.createElement(
					...
					a.createElement(qo, { hidden: l, interstitial: i }, e),
					a.createElement(
						qo,
						{ hidden: !l },
						a.createElement(Q2, { onClose: () => o(!1) }),
					),
					t,
				);
			},
			...
			dm = ({ value: e, placeholder: t, suffix: n }) =>
				a.createElement(
					sm,
					null,
			...
			a0 = ({ id: e, value: t, placeholder: n, suffix: r, ...i }) =>
				a.createElement(
					om,
					null,
					a.createElement(_s, {
				...
				a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							{
								asChild: !0,
								ariaLabel: 'Learn about visual tests',
							},
							a.createElement(
								'a',
								{
			...
			hm = ({ onBack: e, onSignIn: t }) => {
				let [n, r] = be(''),
					[i, l] = be(null),
					o = z((d) => {
						(r(wl(d.target.value)), l(null));
					}, []),
					s = z(
						(d) => {
							d.preventDefault();
							let c = zs(n);
							c ? t(c) : l('Please enter a subdomain');
						},
						[n, t],
					);
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								...
								a.createElement(de, null, 'Sign in with SSO'),
								a.createElement(
									q,
									{ muted: !0 },
			...
			gm = ({ onBack: e, onSignIn: t, onSignInWithSSO: n }) =>
				a.createElement(
					he,
					{ footer: null, ignoreConfig: !0 },
					a.createElement(Ll, { onBack: e }),
			...
			A;
		function Ne(e) {
			return new Ui(`Syntax Error: Unexpected token at ${A} in ${e}`);
		}
		function Go(e) {
			if (((e.lastIndex = A), e.test(B)))
				return B.slice(A, (A = e.lastIndex));
		}
		var $a = / +(?=[^\s])/y;
		function ym(e) {
			for (
...
`),
				...
				(($a.lastIndex = 0),
					$a.test(t[o]) &&
						(o && (!r || $a.lastIndex < r) && (r = $a.lastIndex),
						(i = i || o),
						(l = o)));
			for (var s = i; s <= l; s++)
				(s !== i &&
...
`),
		...
		function Nl() {
			...
			if (e === A - 1) throw Ne('Name');
			var n = B.slice(e, --A);
			return (ae(), n);
		}
		function Oe() {
			return { kind: 'Name', value: Nl() };
		}
		var bm = /(?:"""|(?:[\s\S]*?[^\\])""")/y,
			Em = /(?:(?:\.\d+)?[eE][+-]?\d+|\.\d+)/y;
		function Nn(e) {
			...
			switch (B.charCodeAt(A)) {
				case 91:
					(A++, ae());
					for (var n = []; B.charCodeAt(A) !== 93;) n.push(Nn(e));
					return (A++, ae(), { kind: 'ListValue', values: n });
				case 123:
					(A++, ae());
					for (var r = []; B.charCodeAt(A) !== 125;) {
						var i = Oe();
						if (B.charCodeAt(A++) !== 58) throw Ne('ObjectField');
						(ae(),
							r.push({
								kind: 'ObjectField',
								name: i,
					...
					return (A++, ae(), { kind: 'ObjectValue', fields: r });
				case 36:
				...
				case 34:
					if (
						...
						if (((A += 3), (t = Go(bm)) == null))
							throw Ne('StringValue');
						return (
							ae(),
							{
								kind: 'StringValue',
								value: ym(t.slice(0, -3)),
								block: !0,
							}
						);
					} else {
				...
				case 57:
					for (
						var d = A++, c;
						(c = 0 | B.charCodeAt(A++)) >= 48 && c <= 57;
					);
					var m = B.slice(d, --A);
					if ((c = B.charCodeAt(A)) === 46 || c === 69 || c === 101) {
						if ((t = Go(Em)) == null) throw Ne('FloatValue');
						return (ae(), { kind: 'FloatValue', value: m + t });
					} else return (ae(), { kind: 'IntValue', value: m });
				case 110:
					if (
			...
			return { kind: 'EnumValue', value: Nl() };
		}
		function r0(e) {
			if (B.charCodeAt(A) === 40) {
				...
				do {
					var n = Oe();
					if (B.charCodeAt(A++) !== 58) throw Ne('Argument');
					(ae(), t.push({ kind: 'Argument', name: n, value: Nn(e) }));
		...
		function km() {
			for (var e = 0; B.charCodeAt(A) === 91;) (e++, A++, ae());
			var t = { kind: 'NamedType', name: Oe() };
			do
				if (
					(B.charCodeAt(A) === 33 &&
						(A++, ae(), (t = { kind: 'NonNullType', type: t })),
					e)
				) {
					if (B.charCodeAt(A++) !== 93) throw Ne('NamedType');
					(ae(), (t = { kind: 'ListType', type: t }));
				}
			while (e--);
			return t;
		}
		function vr() {
			if (B.charCodeAt(A++) !== 123) throw Ne('SelectionSet');
			return (ae(), yr());
		}
		function yr() {
			var e = [];
			do
				if (B.charCodeAt(A) === 46) {
					...
					var t = Oe(),
						n = void 0;
					B.charCodeAt(A) === 58 && (A++, ae(), (n = t), (t = Oe()));
					var r = r0(!1),
						i = _t(!1),
						l = void 0;
					(B.charCodeAt(A) === 123 && (A++, ae(), (l = yr())),
						e.push({
							kind: 'Field',
							alias: n,
							name: t,
			...
			return (A++, ae(), { kind: 'SelectionSet', selections: e });
		}
		function wm() {
			if ((ae(), B.charCodeAt(A) === 40)) {
				var e = [];
				(A++, ae());
				do {
					var t = void 0;
					if (
						(B.charCodeAt(A) === 34 && (t = Nn(!0)),
						B.charCodeAt(A++) !== 36)
					)
						throw Ne('Variable');
					var n = Oe();
					if (B.charCodeAt(A++) !== 58)
						throw Ne('VariableDefinition');
					ae();
					var r = km(),
						i = void 0;
					(B.charCodeAt(A) === 61 && (A++, ae(), (i = Nn(!0))), ae());
					var l = {
...
`),
						...
						e.variableDefinitions &&
							...
							(t +=
								...
								Ie(
									e.variableDefinitions,
									', ',
									ge.VariableDefinition,
								) +
								')')),
						e.directives &&
							e.directives.length &&
							(t += ' ' + Ie(e.directives, ' ', ge.Directive)));
					var n = ge.SelectionSet(e.selectionSet);
				...
				VariableDefinition(e) {
					...
					return (
						e.description &&
							(t += ge.StringValue(e.description) + ' '),
						(t += ge.Variable(e.variable) + ': ' + wt(e.type)),
						e.defaultValue && (t += ' = ' + wt(e.defaultValue)),
						e.directives &&
							e.directives.length &&
							(t += ' ' + Ie(e.directives, ' ', ge.Directive)),
						t
				...
				Field(e) {
					...
					if (e.arguments && e.arguments.length) {
						var n = Ie(e.arguments, ', ', ge.Argument);
						t.length + n.length + 2 > 80
							? (t +=
									'(' +
									(st += '  ') +
									Ie(e.arguments, st, ge.Argument) +
									(st = st.slice(0, -2)) +
									')')
							: (t += '(' + n + ')');
					}
					return (
						...
						e.selectionSet &&
							...
							(t += ' ' + ge.SelectionSet(e.selectionSet)),
						t
					);
				},
				StringValue(e) {
				...
				ListValue: (e) => '[' + Ie(e.values, ', ', wt) + ']',
				ObjectValue: (e) =>
					'{' + Ie(e.fields, ', ', ge.ObjectField) + '}',
				ObjectField: (e) => e.name.value + ': ' + wt(e.value),
				Document(e) {
...
`,
				...
				SelectionSet: (e) =>
					'{' +
					(st += '  ') +
					Ie(e.selections, st, wt) +
					(st = st.slice(0, -2)) +
					'}',
				Argument: (e) => e.name.value + ': ' + wt(e.value),
				FragmentSpread(e) {
					var t = '...' + e.name.value;
					return (
						e.directives &&
				...
				Directive(e) {
					...
					return (
						e.arguments &&
							e.arguments.length &&
							(t +=
								'(' + Ie(e.arguments, ', ', ge.Argument) + ')'),
						t
					);
				},
				NamedType: (e) => e.name.value,
				ListType: (e) => '[' + wt(e.type) + ']',
				NonNullType: (e) => wt(e.type) + '!',
			},
			wt = (e) => ge[e.kind](e);
		function Lm(e) {
			return (
...
`),
				...
				(t((s) => {
					...
					n(
						et((s) => {
							if (s === 1) {
								o || ((o = !0), i(1));
								for (var d = 0, c = r, m = r.length; d < m; d++)
									c[d](1);
								r.length = 0;
							} else {
								!o && !l ? ((l = !0), i(0)) : (l = !1);
								for (var u = 0, p = r, f = r.length; u < f; u++)
									p[u](0);
							}
						}),
					));
			...
			return (i) => {
				(t.push(i),
					t.length === 1 &&
						e((l) => {
							if (l === 0) {
								for (var o = 0, s = t, d = t.length; o < d; o++)
									s[o](0);
								t.length = 0;
							} else if (l.tag === 0) n = l[0];
							else {
								r = !1;
								for (var c = 0, m = t, u = t.length; c < u; c++)
									m[c](l);
							}
						}),
					i(
		...
		function Wi() {
			var e, t;
			return {
				source: xa(Im((n) => ((e = n.next), (t = n.complete), i0))),
				next(n) {
					e && e(n);
				},
				complete() {
...
`),
			...
			Jo = new WeakMap(),
			gn = (e, t) => {
				if (e === null || Kt.has(e)) return 'null';
				if (typeof e != 'object') return JSON.stringify(e) || '';
				if (e.toJSON) return gn(e.toJSON(), t);
				if (Array.isArray(e)) {
					...
					!t &&
					((kr !== Tn && e instanceof kr) ||
						(wr !== Tn && e instanceof wr))
				)
					return 'null';
				...
				if (
					...
					var o = Jo.get(e) || Math.random().toString(36).slice(2);
					return (Jo.set(e, o), gn({ __key: o }, t));
				}
				Kt.add(e);
				...
				if (!(
					...
					if (Array.isArray(n))
						for (var r = 0, i = n.length; r < i; r++)
							qi(e, `${t}.${r}`, n[r]);
					else if (n instanceof kr || n instanceof wr) e.set(t, n);
					else {
						Kt.add(n);
						for (var l in n) qi(e, `${t}.${l}`, n[l]);
					}
			},
			Er = (e, t) => (Kt.clear(), gn(e, t || !1)),
			Tn = class {},
			kr = typeof File < 'u' ? File : Tn,
			wr = typeof Blob < 'u' ? Blob : Tn,
			Rm = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g,
			Bm = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g,
			Pm = (e, t) =>
				t % 2 == 0
...
`,
					...
					: e,
			Xo = (e) => e.split(Rm).map(Pm).join('').trim(),
			e1 = new Map(),
			lr = new Map(),
			_l = (e) => {
				var t;
				return (
					typeof e == 'string'
						? (t = Xo(e))
						: e.loc && lr.get(e.__key) === e
							? (t = e.loc.source.body)
							: ((t = e1.get(e) || Xo(Lm(e))), e1.set(e, t)),
					typeof e != 'string' &&
						!e.loc &&
						(e.loc = {
							start: 0,
			...
			t1 = (e) => {
				var t;
				if (e.documentId) t = ir(e.documentId);
				else if (((t = ir(_l(e))), e.definitions)) {
					var n = u0(e);
					n &&
						(t = ir(
							`
# ${n}`,
			...
			Vm = (e) => {
				...
				return (
					typeof e == 'string'
						? ((t = t1(e)),
							(n = lr.get(t) || Sm(e, { noLocation: !0 })))
						: ((t = e.__key || t1(e)), (n = lr.get(t) || e)),
					n.loc || _l(n),
					(n.__key = t),
					lr.set(t, n),
					n
			...
			u0 = (e) => {
				for (var t = 0, n = e.definitions.length; t < n; t++) {
					...
					if (r.kind === vm.OPERATION_DEFINITION)
			...
			n1 = (e, t, n) => {
				...
				return {
					...
					error: Array.isArray(t.errors)
						? new Ml({ graphQLErrors: t.errors, response: n })
						: void 0,
			...
			Hm = (e, t, n, r) => {
					...
					for (
						var c = function () {
								...
								if (p.path) y = p.path;
									...
									var w = r.find((L) => L.id === p.id);
									p.subPath
										? (y = [...w.path, ...p.subPath])
										: (y = w.path);
								}
								for (var b = 0, g = y.length; b < g; f = y[b++])
									h = h[f] = Array.isArray(h[f])
										? [...h[f]]
										: { ...h[f] };
								if (p.items)
									for (
				...
				return {
					...
					data: d.data,
					error: i.length
						? new Ml({ graphQLErrors: i, response: n })
						: void 0,
			...
			m0 = (e, t, n) => ({
				operation: e,
				data: void 0,
				error: new Ml({ networkError: t, response: n }),
				extensions: void 0,
				hasNext: !1,
				stale: !1,
			});
		...
		var jm = (e, t) => {
				...
				var r = zm(e.context.url);
				for (var i in t) {
					var l = t[i];
					l && r[1].set(i, typeof l == 'object' ? Er(l) : l);
				}
				var o = r.join('?');
			...
			$m = (e, t) => {
				...
				if (r.headers)
					if (
						((o) => 'has' in o && !Object.keys(o).length)(r.headers)
					)
		...
		async function* a1(e) {
			if (e.body[Symbol.asyncIterator])
				for await (var t of e.body) yield t;
			else {
...
`,
		...
		function i1(e) {
			...
			return (
				(t.toPromise = () =>
					Tl(Dr(1)(Re((n) => !n.stale && !n.hasNext)(t)))),
		...
		var Km = () => {},
			...
			e4 = function e(t) {
				...
				function u(g) {
					if ((g && c(g), !m)) {
						for (m = !0; m && (g = o.shift());) c(g);
						m = !1;
					}
				}
				var p = (g) => {
						var v = s0(
							Re((E) => E.kind === 'teardown' && E.key === g.key)(
								d.source,
							),
						)(
							Re(
							...
							g.kind !== 'mutation'
								? (v = Fl(() => {
										...
										for (var E = o.length - 1; E >= 0; E--)
											o[E].key === g.key &&
												o.splice(E, 1);
										c(Sr('teardown', g, g.context));
									})(
										br((E) => {
											if (E.stale)
												if (!E.hasNext) l.delete(g.key);
												else
													for (
														var S = 0;
														S < o.length;
					...
					h = Object.assign(f, {
						...
						reexecuteOperation(g) {
							if (g.kind === 'teardown') u(g);
							else if (g.kind === 'mutation')
								(o.push(g), Promise.resolve().then(u));
							else if (i.has(g.key)) {
						...
						executeQuery(g, v) {
							var E = h.createRequestOperation('query', g, v);
							return h.executeRequestOperation(E);
						},
						executeSubscription(g, v) {
							var E = h.createRequestOperation(
								'subscription',
								g,
								v,
							);
						...
						executeMutation(g, v) {
							var E = h.createRequestOperation('mutation', g, v);
							return h.executeRequestOperation(E);
						},
						readQuery(g, v, E) {
							var S = null;
							return (
								Fn((L) => {
									S = L;
								})(h.query(g, v, E)).unsubscribe(),
								S
							);
						},
						query: (g, v, E) => h.executeQuery(yn(g, v), E),
						subscription: (g, v, E) =>
							h.executeSubscription(yn(g, v), E),
						mutation: (g, v, E) => h.executeMutation(yn(g, v), E),
					}),
					y = Km,
					w = Jm(t.exchanges),
					b = xa(
		...
		var Il = () => {
			...
			hi = (e, t) => {
				...
				return ((r, i) => {
					...
					for (var o in i)
						if (o === 'operation' ? !a4(r[o], i[o]) : r[o] !== i[o])
							return !0;
					return !1;
				})(e, n)
					? n
		...
		function Ol(e) {
			var t = Il(),
				...
				[d, c] = be(() => [l, hi(Gi, o(l, r)), s]),
				m = d[1];
			(l !== d[0] && r4(d[2], s) && c([l, (m = hi(d[1], o(l, r))), s]),
				Q(() => {
					var p = d[0],
						f = d[2][1],
						h = !1,
		...
		var s4 = J.union([
				J.object({ message: J.literal('login') }),
				J.object({
					message: J.literal('grant'),
					code: J.string(),
					state: J.string(),
				}),
				J.object({
				...
				J.object({
					message: J.literal('createdProject'),
					projectId: J.string(),
				}),
			]),
			h0 = (e) => {
				...
				return (
					Q(() => {
						let r = ({ origin: i, data: l, source: o }) => {
							if (!n.current.has(i) || o !== t.current) return;
							let s;
							try {
								s = s4.parse(l);
							} catch {
						...
						z((r, i = []) => {
							if (
								...
								let o =
										...
										window.screenLeft,
									s = `scrollbars=yes,width=800,height=800,top=${(window.innerHeight - 800) / 2 + window.screenTop},left=${o}`;
							...
							if (!t.current)
								return ((n.current = new Set()), !1);
							let { origin: l } = new URL(r);
							return ((n.current = new Set([l, ...i])), !0);
						}, []),
						z(() => {
							(t.current?.close(),
								(t.current = null),
			...
			u4 = (e, t) => M2({ ...e, code: t }),
			m4 = (e, t) => {
				if (e.message === 'login') return { kind: 'login' };
				if (e.message !== 'grant') return { kind: 'ignore' };
				let n = d4.safeParse(e);
				if (n.success)
					return n.data.state !== t
						? { kind: 'ignore' }
						: {
								kind: 'error',
								message:
									n.data.error_description || n.data.error,
							};
				let r = c4.safeParse(e);
				return r.success
					? r.data.state !== t
						? { kind: 'error', message: 'Invalid OAuth state' }
						: { kind: 'code', code: r.data.code }
					: {
							kind: 'error',
							message: 'Unexpected OAuth callback payload',
						};
			};
		function f0({ onAuthenticated: e, onError: t, onMessage: n }) {
			let r = me(null),
				i = me(),
				l = me(),
				o = z(
					async (c) => {
						let m = {
								closeDialog: () => l.current?.(),
								openDialog: (p, f) => i.current?.(p, f),
							},
							u = r.current;
						if (u) {
							let p = m4(c, u.state);
			...
			return (
				...
				(l.current = d),
				{
					begin: z((c) => {
						r.current = c;
						let m = new URL(c.redirectUri).origin;
						i.current?.(c.authorizationUrl, [m]);
					}, []),
					openDialog: s,
					closeDialog: d,
				}
		...
		var fi = (e, t) => Sr(e.kind, e, { ...e.context, authAttempt: t });
		function x4(e) {
						...
						Re((b) =>
							...
							(function (g) {
								return (
									m &&
									m.didAuthError &&
									m.didAuthError(g.error, g.operation)
								);
							})(b) &&
		...
		var F4 =
			...
			l1 = { randomUUID: F4 };
		function T4(e, t, n) {
			if (l1.randomUUID && !t && !e) return l1.randomUUID();
			e = e || {};
			let r = e.random ?? e.rng?.() ?? N4();
			if (r.length < 16)
		...
		var M4 = T4,
			_4 = 1e4,
			g0 = `${j}/session-expired`,
			I4 = (e) => {
				try {
					let t = x2.safeParse(JSON.parse(e));
			...
			O4 = class {
				constructor() {
					((this.auth = null),
						...
						(this.fallbackSessionId = M4()),
						(this.handleStorageEvent = (e) => {
							e.key === Yn && this.applyParsedAuth(e.newValue);
						}),
				...
				notifySessionExpired() {
					typeof window > 'u' ||
						window.dispatchEvent(new window.CustomEvent(g0));
				}
				persist() {
					let e = this.storage;
					e &&
						(this.auth
							? e.setItem(Yn, JSON.stringify(this.auth))
							: e.removeItem(Yn));
				}
				applyParsedAuth(e) {
					let t = e ? I4(e) : null;
					(e && !t && this.storage?.removeItem(Yn),
						this.setAuth(t, { persist: !1 }));
				}
				loadFromStorage() {
					this.applyParsedAuth(this.storage?.getItem(Yn) ?? null);
				}
				async attemptRefresh() {
					let e = this.auth;
					if (!e) throw new ji('Token refresh failed (401)');
					let t = this.generation,
						n = new AbortController();
					this.refreshAbort = n;
					let r = setTimeout(() => n.abort(), _4);
					try {
						let i = await _2({
						...
						(clearTimeout(r), (this.refreshAbort = null));
					}
				}
				getAuth() {
					return this.auth;
				...
				setAuth(e, { persist: t = !0 } = {}) {
					(this.identityChanged(this.auth, e) &&
						((this.generation += 1),
				...
				setToken(e) {
					...
					this.auth && this.setAuth({ ...this.auth, accessToken: e });
				}
				clear() {
					this.setAuth(null);
				}
			...
			Yi = (e) => vt.setAuth(e),
			zr = () => {
				let [{ token: e }, t] = Kl(`${j}/accessToken`, {
						token: vt.getToken(),
					}),
					n = a.useCallback((r) => {
						vt.setToken(r);
			...
			v0 = (e, t) => ({
				headers: {
					...
					'X-Chromatic-Session-ID': t || vt.getSessionId(),
				},
			}),
			B4 = (e) => {
				try {
					...
					let n = t.replace(/-/g, '+').replace(/_/g, '/'),
						r = '='.repeat((4 - (n.length % 4)) % 4),
						i = JSON.parse(globalThis.atob(`${n}${r}`));
					return typeof i.exp == 'number' ? i.exp : null;
				} catch {
					return null;
				}
			},
					...
					exchanges: [
						x4(async (t) => ({
							...
							didAuthError: (n) =>
								...
								n.graphQLErrors.some((r) =>
									r.message.includes('Must login'),
								),
							async refreshAuth() {
								await vt.refresh();
							},
							willAuthError() {
								return !vt.getToken() || P4();
							},
						})),
						Qm,
					],
			...
			o1 = Z4,
			V4 = ({ children: e, value: t = y0() }) =>
				a.createElement(n4, { value: t }, e),
			H4 = J.object({
				message: J.literal('createdProject'),
				projectId: J.string(),
			}),
...
`),
			j4 = ({
				...
				let l = Il(),
					...
					s = me(),
					{ begin: d } = f0({
						onAuthenticated: async (c, m) => {
							try {
								s.current = c;
								let u = v0(c.accessToken, c.sessionId),
									{ data: p } = await l.query(
										D4,
										{},
										{ fetchOptions: u },
									);
								...
								if (p.viewer.projectCount > 0 || t) {
									(Yi(c), n(c.accessToken), m.closeDialog());
									return;
								}
								if (!p.viewer.accounts[0])
									throw new Error('User has no accounts!');
								if (!p.viewer.accounts[0].newProjectUrl)
									throw new Error(
										'Unexpected missing project URL',
									);
								m.openDialog(
									p.viewer.accounts[0].newProjectUrl,
								);
							} catch (u) {
								o('Login Error', u);
							}
						},
						onError: (c) => o('Login Error', c),
						onMessage: (c, m) => {
							let u = H4.safeParse(c);
							if (u.success) {
								if (!s.current) {
									o(
										'Unexpected missing auth session',
										new Error(),
									);
									return;
								}
								(Yi(s.current),
									n(s.current.accessToken),
									r(`Project:${u.data.projectId}`),
									m.closeDialog());
							}
						},
					});
			...
			W4 = k.div({ display: 'flex', gap: 8 }),
			q4 = k.div({ display: 'flex', flexDirection: 'column', gap: 8 }),
			G4 = k.div(({ theme: e }) => ({
				display: 'flex',
				flexDirection: 'column',
				maxWidth: 400,
			...
			K4 = ({ onNext: e, onUninstall: t }) =>
				a.createElement(
							...
							a.createElement(
								...
								a.createElement(
									...
									a.createElement(
										...
										null,
										'Light mode',
										a.createElement(xc, { size: 10 }),
									),
									a.createElement(b0, { alt: '' }),
									a.createElement(k0, { alt: '' }),
									a.createElement(E0, { alt: '' }),
								),
							),
						),
					),
					a.createElement(
						$4,
						null,
						a.createElement(q, { muted: !0 }, 'Not interested?'),
						a.createElement(
							xe,
							{ onClick: () => t() },
			...
			Q4 = ({
				...
				if (r === 'signin' || (r === 'welcome' && n))
					return a.createElement(gm, {
						...(n ? {} : { onBack: () => i('welcome') }),
						onSignIn: m,
						onSignInWithSSO: () => i('subdomain'),
					});
				if (r === 'subdomain')
					return a.createElement(hm, {
						onBack: () => i('signin'),
						onSignIn: m,
					});
				if (r === 'verify') {
...
`,
			...
			yi = k(X4)(({ theme: e }) => ({
				...
				padding: 4,
				borderRadius: '50%',
				animation: `${ep} 3.72s ease infinite`,
...
`),
			lp = ({ projectId: e, configFile: t, goToNext: n }) => {
				De('LinkProject', 'LinkedProject');
				let [{ data: r, fetching: i, error: l }] = Ol({
					query: ip,
...
`)),
		...
		function cp({ projectId: e, configFile: t }) {
			return (
...
`),
			...
			Ga = k.div({ height: '100%', overflowY: 'auto' }),
			hp = k(oe)({ width: '100%' }),
			fp = k(z5)({ marginRight: 10 });
		function gp({
			createdProjectId: e,
			setCreatedProjectId: t,
			onSelectProjectId: n,
		}) {
			let [{ data: r, fetching: i, error: l }, o] = Ol({ query: mp });
			Q(() => {
				let g = setInterval(o, 5e3);
				return () => clearInterval(g);
			}, [o]);
			let [s, d] = Se('selectedAccountId'),
				c = r?.viewer?.accounts.find((g) => g.id === s),
				m = z((g) => d(g.id), [d]);
			Q(() => {
				!s && r?.viewer?.accounts && m(r.viewer.accounts[0]);
			}, [r, s, m]);
			let [u, p] = Se('isSelectingProject', !1),
				f = z(
					(g) => {
						(p(!0), n(g.id));
						let v = setTimeout(() => {
				...
				h = z(
					async (g) => {
						let v = up.safeParse(g);
						v.success && (o(), t(v.data.projectId));
					},
					[o, t],
				),
				[y, w] = h0(h),
				b = e && c?.projects?.find((g) => g?.id.endsWith(e));
			return (
				Q(() => {
					b && (w(), f(b));
				}, [b, f, w]),
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								'div',
								null,
								a.createElement(de, null, 'Select a project'),
								a.createElement(
									q,
									{ muted: !0 },
							...
							!r &&
								...
								a.createElement(
									...
									a.createElement(
										s1,
										null,
										a.createElement(qa, null, 'Accounts'),
										a.createElement(
											Ga,
											null,
											a.createElement(Qe, {
									...
									a.createElement(
										d1,
										null,
										a.createElement(qa, null, 'Projects'),
										a.createElement(
											Ga,
		...
		var vp = () =>
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								'div',
								null,
								a.createElement(de, null, 'Visual tests'),
								a.createElement(
									q,
									{ center: !0, muted: !0 },
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								'div',
								null,
								a.createElement(de, null, 'Uninstall complete'),
								a.createElement(
									q,
									{ center: !0, muted: !0 },
			...
			w0 = { isRunning: !1, startBuild: () => {}, stopBuild: () => {} },
			C0 = $e(w0),
			Fa = () => Et(C0, 'RunBuild'),
			Ep = ({ children: e, watchState: t = w0 }) =>
				a.createElement(C0.Provider, { value: t }, e),
			Zl = (e, t) =>
				!e?.branch || !t?.branch
					? !1
					: e.branch.split(':').at(-1) !== t.branch ||
						e.commit !== t.commit ||
						e.uncommittedHash !== t.uncommittedHash,
			Ki = {
		...
		function wp(e) {
			...
			return (
				e?.forEach((n) => {
					...
					if (!r) {
						t[n.story.storyId] = Ki[n.status];
						return;
					}
					t[n.story.storyId] = kp(r, Ki[n.status]);
				}),
		...
		var u1 = {
			...
			S0 = ({
				...
				let { heading: r, message: i, action: l } = u1[n] || u1.OTHER;
				return a.createElement(
					he,
					{ footer: null },
					a.createElement(
		...
		var xp = x0('function'),
			...
			p1 = (e) => !Lp(e) && !Ap(e) && (xp(e) || typeof e == 'object'),
			Lp = x0('undefined');
		function Np(e, t) {
			let { length: n } = e;
		...
		function Fe(e, t) {
			...
			if (e && p1(e) && t && p1(t)) {
				...
				if (Array.isArray(e) && Array.isArray(t)) return Np(e, t);
				if (e instanceof Map && t instanceof Map) return Tp(e, t);
				...
				for (let i = n.length; i-- !== 0;) {
					let l = n[i];
					if (!(l === '_owner' && e.$$typeof) && !Fe(e[l], t[l]))
						return !1;
				}
				return !0;
			}
		...
		_.asyncGeneratorFunction = (e) => Ur(e) === 'AsyncGeneratorFunction';
		...
		_.number = (e) => Rn('number')(e) && !_.nan(e);
		_.numericString = (e) =>
		...
		_.primitive = (e) => _.null(e) || Zp(typeof e);
		...
		_.string = Rn('string');
		_.symbol = Rn('symbol');
		_.undefined = Rn('undefined');
		_.weakMap = nt('WeakMap');
		_.weakSet = nt('WeakSet');
		var Z = _;
		function Bp(...e) {
			return e.every(
				(t) => Z.string(t) || Z.array(t) || Z.plainObject(t),
			);
		}
		function Pp(e, t, n) {
			return A0(e, t)
				? [e, t].every(Z.array)
					...
					: [e, t].every(Z.plainObject)
						? !Object.entries(e).some(v1(n)) &&
							Object.entries(t).some(v1(n))
						: t === n
				: !1;
		}
		function h1(e, t, n) {
			let { actual: r, key: i, previous: l, type: o } = n,
				...
				c =
					...
					(o === 'increased' ? s < d : s > d);
			return (
				Z.undefined(r) || (c = c && d === r),
				Z.undefined(l) || (c = c && s === l),
				c
			);
		}
		function f1(e, t, n) {
			...
			if (!Z.nullOrUndefined(l)) {
				if (Z.defined(d)) {
					if (Z.array(d) || Z.plainObject(d)) return Pp(d, c, l);
				} else return Fe(c, l);
				return !1;
			}
			return [o, s].every(Z.array)
				...
				: [o, s].every(Z.plainObject)
					? Vp(Object.keys(d), Object.keys(c))
					: ![o, s].every((m) => Z.primitive(m) && Z.defined(m)) &&
						(i === 'added'
							? !Z.defined(o) && Z.defined(s)
							: Z.defined(o) && !Z.defined(s));
		}
		function g1(e, t, { key: n } = {}) {
			let r = pt(e, n),
				i = pt(t, n);
			if (!A0(r, i)) throw new TypeError('Inputs have different types');
			if (!Bp(r, i)) throw new TypeError("Inputs don't have length");
			return (
				[r, i].every(Z.plainObject) &&
		...
		function v1(e) {
			return ([t, n]) =>
				Z.array(e)
					? Fe(e, n) ||
						e.some((r) => Fe(r, n) || (Z.array(n) && Rl(n)(r)))
					: Z.plainObject(e) && e[t]
						? !!e[t] && Fe(e[t], n)
						: Fe(e, n);
		}
		...
		function y1(e) {
			return (t) =>
				Z.array(e)
					? e.some((n) => Fe(n, t) || (Z.array(t) && Rl(t)(n)))
					: Fe(e, t);
		}
		function Qn(e, t) {
		...
		function Ar(e, t) {
			...
			return {
				added: (n, r) => {
					try {
						return f1(e, t, { key: n, type: 'added', value: r });
					} catch {
						return !1;
					}
				},
				changed: (n, r, i) => {
					try {
						...
						return [l, o].every(Z.array) ||
							[l, o].every(Z.plainObject)
							? !Fe(l, o)
							: l !== o;
					} catch {
						return !1;
				...
				removed: (n, r) => {
					try {
						return f1(e, t, { key: n, type: 'removed', value: r });
					} catch {
						return !1;
					}
				},
		...
		var Hp = bt(Jd(), 1),
			...
			Dp = (function () {
				for (
					...
					if (Ta && navigator.userAgent.indexOf(e[t]) >= 0) return 1;
				return 0;
			})();
		function jp(e) {
			var t = !1;
		...
		function Ma(e) {
			...
			var t = an(e),
				...
				r = t.overflowX,
				i = t.overflowY;
			return /(auto|scroll|overlay)/.test(n + i + r) ? e : Ma(Bl(e));
		}
		function F0(e) {
			return e && e.referenceNode ? e.referenceNode : e;
		}
		var E1 = Ta && !!(window.MSInputMethodContext && document.documentMode),
			k1 = Ta && /MSIE 10/.test(navigator.userAgent);
		function Bn(e) {
			return e === 11 ? E1 : e === 10 ? k1 : E1 || k1;
		}
		function Mn(e) {
			if (!e) return document.documentElement;
			for (
				var t = Bn(10) ? document.body : null,
		...
		function Wp(e) {
			...
			return t === 'BODY'
				? !1
				: t === 'HTML' || Mn(e.firstElementChild) === e;
		}
		function Qi(e) {
		...
		function Lr(e, t) {
			...
			if ((e !== o && t !== o) || r.contains(i)) return Wp(o) ? o : Mn(o);
			var s = Qi(e);
			return s.host ? Lr(s.host, t) : Lr(e, Qi(t).host);
		}
		function _n(e) {
			var t =
		...
		function T0(e) {
			...
			return {
				height: C1('Height', t, n, r),
				width: C1('Width', t, n, r),
			};
		}
		var Gp = function (e, t) {
				if (!(e instanceof t))
		...
		function Ji(e) {
			...
			var i = {
				...
				l = e.nodeName === 'HTML' ? T0(e.ownerDocument) : {},
		...
		function M0(e) {
			...
			if (an(e, 'position') === 'fixed') return !0;
			var n = Bl(e);
			return n ? M0(n) : !1;
		}
		function _0(e) {
			if (!e || !e.parentElement || Bn()) return document.documentElement;
			for (var t = e.parentElement; t && an(t, 'transform') === 'none';)
				t = t.parentElement;
			...
			if (r === 'viewport') l = Kp(o, i);
				...
				r === 'scrollParent'
					...
					: r === 'window'
						...
						: (s = r);
				var d = Pl(s, o, i);
				if (s.nodeName === 'HTML' && !M0(o)) {
					var c = T0(e.ownerDocument),
						m = c.height,
						u = c.width;
		...
		function I0(e, t, n, r, i) {
			...
			var o = Vl(n, r, l, i),
				...
				d = Object.keys(s)
					.map(function (p) {
						return qe({ key: p }, s[p], { area: Qp(s[p]) });
					})
					.sort(function (p, f) {
		...
		function Jp(e, t, n) {
			...
			var r = _a(e, function (i) {
				return i[t] === n;
			});
			return e.indexOf(r);
		}
		function B0(e, t, n) {
			var r = n === void 0 ? e : e.slice(0, Jp(e, 'name', n));
			return (
		...
		function H0(e, t, n, r) {
			...
			(l.addEventListener(t, n, { passive: !0 }),
				i || H0(Ma(l.parentNode), t, n, r),
				r.push(l));
		}
		function t3(e, t, n, r) {
			((n.updateBound = r),
				V0(e).addEventListener('resize', n.updateBound, {
					passive: !0,
				}));
			var i = Ma(e);
			return (
		...
		function a3(e, t) {
			return (
				V0(e).removeEventListener('resize', t.updateBound),
		...
		function r3() {
			this.state.eventsEnabled &&
				...
				(this.state = a3(this.reference, this.state)));
		}
		function Dl(e) {
		...
		function l3(e) {
			return (
				...
				i3(e.instance.popper, e.attributes),
				e.arrowElement &&
		...
		function o3(e, t, n, r, i) {
			var l = O0(i, t, e, n.positionFixed),
				o = I0(
					n.placement,
					l,
					t,
		...
		var d3 = Ta && /Firefox/i.test(navigator.userAgent);
		function c3(e, t) {
			var n = t.x,
				r = t.y,
				i = e.offsets.popper,
				l = _a(e.instance.modifiers, function (v) {
			...
			var o = l !== void 0 ? l : t.gpuAcceleration,
				...
				m = s3(e, window.devicePixelRatio < 2 || !d3),
			...
			if (
				...
				var w = u === 'bottom' ? -1 : 1,
					b = p === 'right' ? -1 : 1;
				((c[u] = y * w), (c[p] = h * b), (c.willChange = u + ', ' + p));
			}
			var g = { 'x-placement': e.placement };
			return (
				(e.attributes = qe({}, g, e.attributes)),
				(e.styles = qe({}, c, e.styles)),
				(e.arrowStyles = qe({}, e.offsets.arrow, e.arrowStyles)),
				e
			);
		}
		function D0(e, t, n) {
			var r = _a(e, function (s) {
					var d = s.name;
					return d === t;
				}),
				i =
		...
		function u3(e, t) {
			var n;
			if (!D0(e.instance.modifiers, 'arrow', 'keepTogether')) return e;
			var r = t.element;
			if (typeof r == 'string') {
			...
			var i = e.placement.split('-')[0],
				...
				f = d ? 'bottom' : 'right',
				h = Z0(r)[c];
			(s[f] - h < o[u] && (e.offsets.popper[u] -= o[u] - (s[f] - h)),
				s[u] + h > o[f] && (e.offsets.popper[u] += s[u] + h - o[f]),
				(e.offsets.popper = Zt(e.offsets.popper)));
			var y = s[u] + s[c] / 2 - h / 2,
				w = an(e.instance.popper),
				b = parseFloat(w['margin' + m]),
				g = parseFloat(w['border' + m + 'Width']),
				v = y - e.offsets.popper[u] - b - g;
			return (
				(v = Math.max(Math.min(o[c] - h, v), 0)),
				(e.arrowElement = r),
				(e.offsets.arrow =
					((n = {}), In(n, u, Math.round(v)), In(n, p, ''), n)),
				e
			);
		}
		function m3(e) {
				...
				(c = c.map(function (m, u) {
					...
					return m
						.reduce(function (h, y) {
							return h[h.length - 1] === '' &&
								['+', '-'].indexOf(y) !== -1
								? ((h[h.length - 1] = y), (f = !0), h)
								: f
									? ((h[h.length - 1] += y), (f = !1), h)
									: h.concat(y);
						}, [])
						.map(function (h) {
							return f3(h, p, t, n);
		...
		function E3(e) {
			if (!D0(e.instance.modifiers, 'hide', 'preventOverflow')) return e;
			var t = e.offsets.reference,
				n = _a(e.instance.modifiers, function (r) {
		...
		var w3 = {
				shift: { order: 100, enabled: !0, fn: b3 },
				offset: { order: 200, enabled: !0, fn: v3, offset: 0 },
				preventOverflow: {
					order: 300,
					enabled: !0,
					fn: y3,
				...
				keepTogether: { order: 400, enabled: !0, fn: h3 },
				arrow: {
					order: 500,
					enabled: !0,
					fn: u3,
				...
				inner: { order: 700, enabled: !1, fn: k3 },
				hide: { order: 800, enabled: !0, fn: E3 },
				computeStyle: {
					order: 850,
					enabled: !0,
					fn: c3,
			...
			$r = (function () {
				function e(t, n) {
					...
					(Gp(this, e),
						...
						Object.keys(
							qe({}, e.Defaults.modifiers, i.modifiers),
						).forEach(function (o) {
		...
		I.asyncGeneratorFunction = function (e) {
			return Wr(e) === 'AsyncGeneratorFunction';
		};
		I.asyncFunction = at('AsyncFunction');
		I.bigint = Pn('bigint');
		...
		I.plainFunction = at('Function');
		I.plainObject = function (e) {
			if (Wr(e) !== 'Object') return !1;
			var t = Object.getPrototypeOf(e);
			return t === null || t === Object.getPrototypeOf({});
		};
		I.primitive = function (e) {
			return I.null(e) || N3(typeof e);
		};
		I.promise = at('Promise');
		I.propertyOf = function (e, t, n) {
		...
		I.string = Pn('string');
		I.symbol = Pn('symbol');
		I.undefined = Pn('undefined');
		I.weakMap = at('WeakMap');
		I.weakSet = at('WeakSet');
		var We = I;
		function z0(e) {
			return function (t) {
				return typeof t === e;
		...
		var F3 = z0('function'),
			...
			L1 = function (e) {
				return !M3(e) && !T3(e) && (F3(e) || typeof e == 'object');
			},
			M3 = z0('undefined'),
			tl = function (e) {
		...
		function _3(e, t) {
			var n = e.length;
			if (n !== t.length) return !1;
			for (var r = n; r-- !== 0;) if (!Be(e[r], t[r])) return !1;
			return !0;
		}
		function I3(e, t) {
			if (e.byteLength !== t.byteLength) return !1;
		...
		function O3(e, t) {
			...
			try {
				for (
					var c = tl(e.entries()), m = c.next();
					!m.done;
					m = c.next()
				) {
					var d = m.value;
					if (!Be(d[1], t.get(d[0]))) return !1;
				}
			} catch (u) {
				i = { error: u };
			} finally {
		...
		function Be(e, t) {
			...
			if (e && L1(e) && t && L1(t)) {
				if (e.constructor !== t.constructor) return !1;
				if (Array.isArray(e) && Array.isArray(t)) return _3(e, t);
				if (e instanceof Map && t instanceof Map) return O3(e, t);
				if (e instanceof Set && t instanceof Set) return Z3(e, t);
				if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t))
					return I3(e, t);
				if (A1(e) && A1(t))
					return e.source === t.source && e.flags === t.flags;
				...
				for (var i = n.length; i-- !== 0;) {
					var l = n[i];
					if (!(l === '_owner' && e.$$typeof) && !Be(e[l], t[l]))
						return !1;
				}
				return !0;
			}
		...
		O.asyncGeneratorFunction = function (e) {
			return qr(e) === 'AsyncGeneratorFunction';
		};
		O.asyncFunction = rt('AsyncFunction');
		O.bigint = Vn('bigint');
		...
		O.object = function (e) {
			return (
				!O.nullOrUndefined(e) && (O.function(e) || typeof e == 'object')
			);
		};
		O.oneOf = function (e, t) {
			return O.array(e) ? e.indexOf(t) > -1 : !1;
		};
		O.plainFunction = rt('Function');
		...
		O.primitive = function (e) {
			return O.null(e) || H3(typeof e);
		};
		O.promise = rt('Promise');
		...
		O.string = Vn('string');
		O.symbol = Vn('symbol');
		O.undefined = Vn('undefined');
		O.weakMap = rt('WeakMap');
		O.weakSet = rt('WeakSet');
		var W = O;
		function D3() {
			for (var e = [], t = 0; t < arguments.length; t++)
				e[t] = arguments[t];
			return e.every(function (n) {
				return W.string(n) || W.array(n) || W.plainObject(n);
			});
		}
		function j3(e, t, n) {
			return U0(e, t)
				? [e, t].every(W.array)
					? !e.some(_1(n)) && t.some(_1(n))
					: [e, t].every(W.plainObject)
						? !Object.entries(e).some(M1(n)) &&
							Object.entries(t).some(M1(n))
						: t === n
				: !1;
		}
		function N1(e, t, n) {
			var r = n.actual,
				...
				c =
					...
					(o === 'increased' ? s < d : s > d);
			return (
				W.undefined(r) || (c = c && d === r),
				W.undefined(l) || (c = c && s === l),
				c
			);
		}
		function F1(e, t, n) {
			var r = n.key,
				...
				d = i === 'added' ? o : s,
				c = i === 'added' ? s : o;
			if (!W.nullOrUndefined(l)) {
				if (W.defined(d)) {
					if (W.array(d) || W.plainObject(d)) return j3(d, c, l);
				} else return Be(c, l);
				return !1;
			}
			return [o, s].every(W.array)
				? !c.every(jl(d))
				: [o, s].every(W.plainObject)
					? z3(Object.keys(d), Object.keys(c))
					: ![o, s].every(function (m) {
							return W.primitive(m) && W.defined(m);
						}) &&
						(i === 'added'
							? !W.defined(o) && W.defined(s)
							: W.defined(o) && !W.defined(s));
		}
		function T1(e, t, n) {
			var r = n === void 0 ? {} : n,
				...
				l = ht(e, i),
				o = ht(t, i);
			if (!U0(l, o)) throw new TypeError('Inputs have different types');
			if (!D3(l, o)) throw new TypeError("Inputs don't have length");
			return (
				[l, o].every(W.plainObject) &&
		...
		function M1(e) {
			return function (t) {
				...
				return W.array(e)
					? Be(e, r) ||
							e.some(function (i) {
								return Be(i, r) || (W.array(r) && jl(r)(i));
							})
					: W.plainObject(e) && e[n]
						? !!e[n] && Be(e[n], r)
						: Be(e, r);
		...
		function _1(e) {
			return function (t) {
				return W.array(e)
					? e.some(function (n) {
							return Be(n, t) || (W.array(t) && jl(t)(n));
						})
					: Be(e, t);
			};
		}
		...
		function U0() {
			...
			return (
				e.every(W.array) ||
				e.every(W.number) ||
				e.every(W.plainObject) ||
				e.every(W.string)
			);
		}
		function ht(e, t) {
			if (W.plainObject(e) || W.array(e)) {
				if (W.string(t)) {
					var n = t.split('.');
				...
				return W.number(t) ? e[t] : e;
			}
			return e;
		}
		function U3(e, t) {
			if ([e, t].some(W.nullOrUndefined))
				throw new Error('Missing required parameters');
			if (
				![e, t].every(function (u) {
					return W.plainObject(u) || W.array(u);
				})
			)
				throw new Error('Expected plain objects or array');
			var n = function (u, p) {
				...
				r = function (u, p, f) {
					try {
						var h = ht(e, u),
							...
							b = W.defined(f);
						if (w || b) {
							var g = b ? Jn(f, h) : !Jn(p, h),
								v = Jn(p, y);
							return g && v;
						}
						return [h, y].every(W.array) ||
							[h, y].every(W.plainObject)
							? !Be(h, y)
							: h !== y;
					} catch {
						return !1;
				...
				i = function (u, p, f) {
					if (!W.defined(u)) return !1;
					try {
						var h = ht(e, u),
							y = ht(t, u),
							w = W.defined(f);
						return Jn(p, h) && (w ? Jn(f, y) : !w);
					} catch {
						return !1;
					}
				},
				l = function (u, p) {
					return W.defined(u) ? r(u, p) : !1;
				},
				o = function (u, p, f) {
					if (!W.defined(u)) return !1;
					try {
		...
		var Y3 = { flip: { padding: 20 }, preventOverflow: { padding: 10 } },
			K3 =
		...
		function th(e, t) {
			if (typeof e != 'function') throw new TypeError(K3);
			if (t && typeof t != 'string') throw new TypeError(Q3);
		}
		function Z1(e, t, n) {
			return (
				th(e, n),
				...
				Oa(n, [
					{
						...
						value: function () {
							dt() &&
								...
								Xn || this.renderPortal());
						},
					},
					{
						key: 'componentDidUpdate',
						value: function () {
							dt() && (Xn || this.renderPortal());
						},
					},
					{
						...
						value: function () {
							!dt() ||
								!this.node ||
								(Xn || qn.unmountComponentAtNode(this.node),
								this.node &&
					...
					},
					{
						...
						value: function () {
							...
							var r = this.props,
								i = r.children,
								l = r.setRef;
							if ((this.node || this.appendNode(), Xn))
								return qn.createPortal(i, this.node);
							var o = qn.unstable_renderSubtreeIntoContainer(
								this,
								i.length > 1
					...
					},
					{
						key: 'render',
						value: function () {
							return Xn ? this.renderReact16() : null;
						},
					},
				]),
				n
		...
		Ce(q0, 'propTypes', {
			children: F.default.oneOfType([F.default.element, F.default.array]),
			hasChildren: F.default.bool,
			id: F.default.oneOfType([F.default.string, F.default.number]),
			placement: F.default.string,
			setRef: F.default.func.isRequired,
			target: F.default.oneOfType([F.default.object, F.default.string]),
		...
		Ce(G0, 'propTypes', {
			placement: F.default.string.isRequired,
			setArrowRef: F.default.func.isRequired,
			styles: F.default.object.isRequired,
		});
		var ih = ['color', 'height', 'width'];
		function Y0(e) {
			var t = e.handleClick,
				n = e.styles,
				r = n.color,
		...
		K0.propTypes = {
			content: F.default.node.isRequired,
			footer: F.default.node,
			handleClick: F.default.func.isRequired,
			open: F.default.bool,
			positionWrapper: F.default.bool.isRequired,
			showCloseButton: F.default.bool.isRequired,
			styles: F.default.object.isRequired,
			title: F.default.node,
		};
		var Q0 = (function (e) {
			Za(n, e);
			var t = Ra(n);
				...
				Oa(n, [
					{
						...
						get: function () {
							...
							return (
								...
								[ie.OPENING, ie.OPEN].indexOf(d) !== -1 &&
									(b = pe(pe({}, b), h)),
								d === ie.CLOSING && (b = pe(pe({}, b), f)),
								d === ie.OPEN && !i && (b = pe(pe({}, b), y)),
					...
					},
					{
						...
						value: function () {
							...
							return (
								i
									? a.isValidElement(i)
										? (c.content = a.cloneElement(i, {
												closeFn: l,
											}))
										: (c.content = i({ closeFn: l }))
									: (c.content = a.createElement(
											K0,
											this.props,
										)),
								d === ie.OPEN && m.push('__floater__open'),
								o ||
									(c.arrow = a.createElement(G0, this.props)),
								a.createElement(
									'div',
									{
										ref: s,
		...
		Ce(Q0, 'propTypes', {
			component: F.default.oneOfType([F.default.func, F.default.element]),
			content: F.default.node,
			disableAnimation: F.default.bool.isRequired,
			footer: F.default.node,
			handleClick: F.default.func.isRequired,
			hideArrow: F.default.bool.isRequired,
			open: F.default.bool,
			placement: F.default.string.isRequired,
			positionWrapper: F.default.bool.isRequired,
			setArrowRef: F.default.func.isRequired,
			setFloaterRef: F.default.func.isRequired,
			showCloseButton: F.default.bool,
		...
		Ce(J0, 'propTypes', {
			...
			handleClick: F.default.func.isRequired,
			handleMouseEnter: F.default.func.isRequired,
			handleMouseLeave: F.default.func.isRequired,
			setChildRef: F.default.func.isRequired,
			setWrapperRef: F.default.func.isRequired,
			style: F.default.object,
			styles: F.default.object.isRequired,
		});
		var lh = { zIndex: 100 };
		function oh(e) {
			var t = (0, el.default)(lh, e.options || {});
			return {
				wrapper: {
					cursor: 'help',
					display: 'inline-flex',
			...
			zl = (function (e) {
				...
				function n(r) {
					...
					return (
						Ia(this, n),
						(i = t.call(this, r)),
						Ce(Ct(i), 'setArrowRef', function (l) {
							i.arrowRef = l;
						}),
						Ce(Ct(i), 'setChildRef', function (l) {
							i.childRef = l;
						}),
						Ce(Ct(i), 'setFloaterRef', function (l) {
							i.floaterRef = l;
						}),
						Ce(Ct(i), 'setWrapperRef', function (l) {
							i.wrapperRef = l;
						}),
						Ce(Ct(i), 'handleTransitionEnd', function () {
							...
							(i.wrapperPopper &&
								...
								i.setState(
									...
									function () {
										...
										o(
											s === ie.OPEN ? 'open' : 'close',
											i.props,
										);
									},
								));
						}),
						Ce(Ct(i), 'handleClick', function () {
							var l = i.props,
								o = l.event,
								s = l.open;
							if (!We.boolean(s)) {
						...
						Ce(Ct(i), 'handleMouseEnter', function () {
							var l = i.props,
								o = l.event,
								s = l.open;
							if (!(We.boolean(s) || Ci())) {
						...
						Ce(Ct(i), 'handleMouseLeave', function () {
							var l = i.props,
								o = l.event,
								s = l.eventDelay,
								d = l.open;
					...
					Oa(n, [
						...
						},
						{
							...
							value: function () {
								...
								if (l) {
									var v = We.undefined(p.offset)
										? 0
										: p.offset;
									new x1(this.target, this.wrapperRef, {
						...
						},
						{
							...
							value: function (r) {
								var i = this.state.status,
									l = i === ie.OPEN ? ie.CLOSING : ie.OPENING;
								(We.undefined(r) || (l = r),
		...
		Ce(zl, 'propTypes', {
			autoOpen: F.default.bool,
			callback: F.default.func,
			children: F.default.node,
			component: Z1(
				F.default.oneOfType([F.default.func, F.default.element]),
				function (e) {
					return !e.content;
				},
			),
			content: Z1(F.default.node, function (e) {
				return !e.component;
			}),
			debug: F.default.bool,
			disableAnimation: F.default.bool,
			disableFlip: F.default.bool,
			disableHoverToClick: F.default.bool,
			event: F.default.oneOf(['hover', 'click']),
			eventDelay: F.default.number,
			footer: F.default.node,
			getPopper: F.default.func,
			hideArrow: F.default.bool,
			id: F.default.oneOfType([F.default.string, F.default.number]),
			offset: F.default.number,
			open: F.default.bool,
			options: F.default.object,
			placement: F.default.oneOf([
				'top',
				'top-start',
				'top-end',
				'bottom',
			...
			target: F.default.oneOfType([F.default.object, F.default.string]),
			title: F.default.node,
			wrapperOptions: F.default.shape({
				offset: F.default.number,
				placement: F.default.oneOf([
					'top',
					'top-start',
		...
		var ch = Object.defineProperty,
			uh = (e, t, n) =>
				t in e
					...
					: (e[t] = n),
			R = (e, t, n) => uh(e, typeof t != 'symbol' ? t + '' : t, n),
			se = {
				INIT: 'init',
				START: 'start',
				STOP: 'stop',
		...
		function yh(e, t) {
			...
			return new Promise((i, l) => {
				let { scrollTop: o } = r,
					s = e > o ? e - o : o - e;
				Hp.default.top(r, e, { duration: s < 100 ? 50 : n }, (d) =>
					d &&
					d.message !== 'Element already at target scroll position'
						? l(d)
						: i(),
				);
			});
		...
		var ea = Va !== void 0;
		function ed(e = navigator.userAgent) {
			let t = e;
			return (
				typeof window > 'u'
					? (t = 'node')
		...
		function ct(e, t = {}) {
			...
			if (l)
				...
				let o = e.type({});
				l = ct(o, t);
			} else l = (0, b1.default)(n);
			return l;
		}
		function bh(e, t) {
			return !Z.plainObject(e) || !Z.array(t)
				? !1
		...
		function P1() {
			return !['chrome', 'safari', 'firefox', 'opera'].includes(ed());
		}
		...
		function al(e, t, n) {
			...
			if (or(e) === 'string') return r(e);
			if (!Xr(e)) return e;
			let { children: i } = e.props;
			if (or(i) === 'string' && i.includes('{step}'))
				return Jr(e, { children: r(i) });
			if (Array.isArray(i))
				return Jr(e, {
					children: i.map((l) =>
						typeof l == 'string' ? r(l) : al(l, t, n),
					),
				});
			if (or(e.type) === 'function' && !Object.values(e.props).length) {
				let l = e.type({});
				return al(l, t, n);
			}
			return e;
		...
		var Sh = {
			...
			V1 = { borderRadius: 4, position: 'absolute' };
		function Nh(e, t) {
			var n, r, i, l, o;
			let { floaterProps: s, styles: d } = e,
				...
				m = (0, Ka.default)(d ?? {}, (r = t.styles) != null ? r : {}),
				u = (0, Ka.default)(Lh, m.options || {}),
			...
			let h = {
				...
				y = {
					...
					beaconOuter: {
						...
						backgroundColor: `rgba(${Eh(u.primaryColor).join(',')}, 0.2)`,
					...
					buttonSkip: { ...ta, color: u.textColor, fontSize: 14 },
					overlay: {
						...h,
					...
					spotlight: { ...V1, backgroundColor: 'gray' },
					spotlightLegacy: {
						...V1,
		...
		function pn(e, t) {
			var n, r, i, l, o, s;
			let d = t ?? {},
				c = Ya.default.all([xh, Fh(e), d], {
					isMergeableObject: Z.plainObject,
				}),
				m = Nh(e, c),
				u = Gr(xt(c.target), c.disableScrollParentFix),
				p = Ya.default.all([
					Sh,
			...
			return (
				(p.offset = c.offset),
				(p.styles = (0, Ya.default)(
					(i = p.styles) != null ? i : {},
					m.floaterStyles,
				)),
				(p.offset +=
					(o =
						(l = e.spotlightPadding) != null
							? l
				...
				{
					...c,
					locale: Ya.default.all([
						nd,
						(s = e.locale) != null ? s : {},
						c.locale || {},
					]),
					floaterProps: p,
					styles: td(m, 'floaterStyles'),
				}
			);
		}
		function ad(e, t = !1) {
			...
			Th = class {
				constructor(e) {
					(R(this, 'beaconPopper'),
						...
						R(this, 'start', (i) => {
							...
							this.setState({
								...this.getNextState(
									{
										action: se.START,
										index: Z.number(i) ? i : l,
									},
									!0,
								),
								status: o ? ne.RUNNING : ne.WAITING,
							});
						}),
						R(this, 'stop', (i = !1) => {
							let { index: l, status: o } = this.getState();
							[ne.FINISHED, ne.SKIPPED].includes(o) ||
								this.setState({
									...this.getNextState({
										action: se.STOP,
										index: l + (i ? 1 : 0),
						...
						R(this, 'update', (i) => {
							...
							if (!bh(i, D1))
								throw new Error(
									`State is not valid. Valid keys: ${D1.join(', ')}`,
								);
							this.setState({
								...this.getNextState(
									{
				...
				getNextState(e, t = !1) {
					...
					let {
						...
						p = Z.number(e.index) ? e.index : c,
						f = d && !t ? c : Math.min(Math.max(p, 0), m);
					return {
			...
			Oh = class extends Dt {
					...
					(super(...arguments),
						...
						R(this, 'hideSpotlight', () => {
							let {
								...
								r = [K.INIT, K.BEACON, K.COMPLETE, K.ERROR];
						...
						R(this, 'handleMouseMove', (e) => {
							let { mouseOverSpotlight: t } = this.state,
								...
								m = d >= r && d <= r + o && c;
							m !== t &&
								this.updateState({ mouseOverSpotlight: m });
						}),
						R(this, 'handleScroll', () => {
							...
							} else On(t, 'sticky') && this.updateState({});
						}),
						R(this, 'handleResize', () => {
				...
				componentDidMount() {
					let {
						...
						i = xt(r);
					((this.scrollParent = Aa(i ?? document.body, n, !0)),
						(this.isActive = !0),
				...
				componentDidUpdate(e) {
					...
					let {
						...
						{ changed: o } = Ar(e, this.props);
					if (o('target') || o('disableScrollParentFix')) {
						let s = xt(l);
						this.scrollParent = Aa(s ?? document.body, n, !0);
					}
				...
				get spotlightStyles() {
					...
					let { showSpotlight: r } = this.state,
						...
						p = gh(c, o, i);
					return {
						...(P1() ? s.spotlightLegacy : s.spotlight),
						height: Math.round(
							((e = m?.height) != null ? e : 0) + o * 2,
						),
				...
				render() {
					...
					if (r()) return null;
					let o = n !== 'center' && e && C(Ih, { styles: l });
					if (ed() === 'safari') {
			...
			Zh = class extends Dt {
				...
				componentDidMount() {
					...
					It() &&
						...
						(this.node.id = e),
						document.body.appendChild(this.node),
						ea || this.renderReact15());
				}
				componentDidUpdate() {
					It() && (ea || this.renderReact15());
				}
				componentWillUnmount() {
					!It() ||
						!this.node ||
				...
				renderReact15() {
					...
					this.node && so(this, e, this.node);
				}
				renderReact16() {
					if (!It() || !ea) return null;
					let { children: e } = this.props;
					return this.node ? Va(e, this.node) : null;
				}
				render() {
      ...
      `),
				...
				C(
					...
					C(
						...
						y &&
							C(
								'h1',
								{ 'aria-label': ct(y), style: h.tooltipTitle },
								y,
							),
					...
					!p &&
						C(
							...
							C('div', { style: h.tooltipFooterSpacer }, w.skip),
							w.back,
							w.primary,
						),
					w.close,
		...
		var Dh = Hh,
					...
					(super(...arguments),
						...
						R(this, 'getElementsProps', () => {
							let {
								...
								g = f;
							if (e) {
								if (((b = c), (g = y), l.showProgress && !n)) {
									let v = ct(m, { step: t + 1, steps: i });
									((b = al(m, t + 1, i)), (g = v));
								}
								n && ((b = d), (g = h));
							}
			...
			zh = class extends Dt {
							...
							(t === 'wrapper'
								...
								o.getPopper('beacon') &&
									(o.getPopper('tooltip') ||
										l.placement === 'center') &&
									i === K.INIT &&
									o.update({ action: r, lifecycle: K.READY }),
				...
				componentDidUpdate(e) {
					...
					let {
						...
						{ changed: h, changedFrom: y } = Ar(e, this.props),
						w = s.info(),
						b = i && n !== se.CLOSE && (d > 0 || n === se.PREV),
						g =
							h('action') ||
							h('index') ||
							h('lifecycle') ||
							h('status'),
						v = y('lifecycle', [K.TOOLTIP, K.INIT], K.INIT),
						E = h('action', [se.NEXT, se.PREV, se.SKIP, se.CLOSE]),
						S = l && d === e.index;
					if (
						(E &&
							(v || S) &&
						...
						let L = xt(p.target),
							N = !!L;
						N && fh(L)
							? (y('status', ne.READY, ne.RUNNING) ||
									y('lifecycle', K.INIT, K.READY)) &&
								r({ ...w, step: p, type: Je.STEP_BEFORE })
							: (console.warn(
									N
										? 'Target not visible'
										: 'Target not mounted',
								...
								r({ ...w, type: Je.TARGET_NOT_FOUND, step: p }),
								l ||
									f.update({
										index: d + (n === se.PREV ? -1 : 1),
									}));
					}
					(y('lifecycle', K.INIT, K.READY) &&
						f.update({
							lifecycle: B1(p) || b ? K.TOOLTIP : K.BEACON,
						}),
						h('index') &&
							nn({
								title: `step:${c}`,
						...
						h('lifecycle', K.BEACON) &&
							r({ ...w, step: p, type: Je.BEACON }),
						h('lifecycle', K.TOOLTIP) &&
							(r({ ...w, step: p, type: Je.TOOLTIP }),
							m &&
								this.tooltip &&
								((this.scope = new Rh(this.tooltip, {
									selector: '[data-action=primary]',
								})),
								this.scope.setFocus())),
						y('lifecycle', [K.TOOLTIP, K.INIT], K.INIT) &&
			...
			id = class extends Dt {
				constructor(e) {
					(super(e),
						...
						R(this, 'handleClickOverlay', () => {
							let { index: o } = this.state,
								{ steps: s } = this.props;
							pn(this.props, s[o]).disableOverlayClose ||
					...
					((this.store = Mh({ ...e, controlled: r && Z.number(i) })),
				...
				componentDidUpdate(e, t) {
					...
					let {
						...
						{ changed: b } = Ar(e, this.props),
						{ changed: g, changedFrom: v } = Ar(t, this.state),
						E = pn(this.props, c[i]),
						S = !Fe(u, c),
						L = Z.number(d) && b('stepIndex'),
						N = xt(E.target);
					if (
						(S &&
							(H1(c, o)
								? f(c)
								: console.warn('Steps are not valid', c)),
						b('run') && (s ? h(d) : y()),
						L)
					) {
						let te = Z.number(m) && m < d ? se.NEXT : se.PREV;
						(n === se.STOP && (te = se.START),
							[ne.FINISHED, ne.SKIPPED].includes(l) ||
								w({
									action: n === se.CLOSE ? se.CLOSE : te,
									index: d,
									lifecycle: K.INIT,
								}));
					}
					...
					let G = { ...this.state, index: i, step: E };
					if (
						g('action', [se.NEXT, se.PREV, se.SKIP, se.CLOSE]) &&
						g('status', ne.PAUSED)
					) {
						let te = pn(this.props, c[t.index]);
						this.callback({
							...G,
							index: t.index,
							lifecycle: K.COMPLETE,
					...
					if (g('status', [ne.FINISHED, ne.SKIPPED])) {
						...
						v('status', [ne.IDLE, ne.READY], ne.RUNNING)
							? this.callback({ ...G, type: Je.TOUR_START })
							: (g('status') || g('action', se.RESET)) &&
								this.callback({ ...G, type: Je.TOUR_STATUS });
					this.scrollToStep(t);
				}
				componentWillUnmount() {
				...
				scrollToStep(e) {
					...
					if (r === ne.RUNNING && p) {
						...
						if (n === K.BEACON && w) {
							let { offsets: g, placement: v } = w;
							!['bottom'].includes(v) &&
								!f &&
								(y = Math.floor(g.popper.top - s));
						} else if (n === K.TOOLTIP && b) {
							let { flipped: g, offsets: v, placement: E } = b;
							['top', 'right', 'left'].includes(E) && !g && !f
								? (y = Math.floor(v.popper.top - s))
								: (y -= m.spotlightPadding);
						}
						((y = y >= 0 ? y : 0),
							r === ne.RUNNING &&
								yh(y, { element: h, duration: o }).then(() => {
									setTimeout(() => {
										var g;
										(g = this.store.getPopper('tooltip')) ==
											null || g.instance.update();
									}, 10);
								}));
					}
				}
		...
		var Uh = id,
			...
			Tr = ([e, ...t]) =>
				t.reduce((n, r) => (j1.indexOf(r) > j1.indexOf(n) ? r : n), e);
		function $h(e) {
			return (e.FAILED ?? 0) > 0
				? 'FAILED'
				: (e.IN_PROGRESS ?? 0) > 0
		...
		function Ul(e) {
			let {
					...
					(u, p) => (
						(u.statusCounts[p.status] =
							(u.statusCounts[p.status] || 0) + 1),
						...
						p.result &&
							...
							(u.brokenCount += 1),
						p.comparisons?.forEach(({ browser: f, result: h }) => {
							u.resultsByBrowser[f.id] = Tr([
								h ?? void 0,
								u.resultsByBrowser[f.id],
							]);
						}),
						p.comparisons?.forEach(({ result: f }) => {
							u.resultsByMode[p.mode.name] = Tr([
								f ?? void 0,
				...
				d = e.length
					? Object.fromEntries(
							e[0].comparisons.map((u) => [
								u.browser.id,
								u.browser,
							]),
						)
					: {},
				c = Object.entries(l).map(([u, p]) => ({
					browser: d[u],
					result: p,
				})),
				m = Object.entries(o).map(([u, p]) => ({
					mode: s[u],
					result: p,
				}));
			return {
		...
		var Wh = (e) => {
			...
			qh = (e, t) => {
				let n = e.filter((i) => i.comparisons.some(ld)),
					r = n.length ? n : e;
		...
		function Yh(e) {
			...
			return (
						...
						n(!1))),
				{
					...
					onSelectBrowser: z((m) => s(m.id), [s]),
					onSelectMode: z((m) => l(m.name), [l]),
				}
			);
		}
		var Kh = tt(`
...
`),
			n7 = ({
				...
				let [{ data: i, error: l, operation: o }, s] = Ol({
					query: Kh,
					variables: {
						projectId: e,
						storyId: t,
						testStatuses: Object.keys(Ki),
						branch: n.branch || '',
						...(n.slug
				...
				let d = o && t && o.variables.storyId !== t,
					c = bn(Qh, i?.project?.lastBuildOnBranch),
					m = [
						...bn(
							Xh,
					...
					p = !!c && !u,
					f = !!c && m.every((y) => y.status !== 'IN_PROGRESS'),
					h = bn(
						Jh,
						i?.selectedBuild ??
							(f ? i?.project?.lastBuildOnBranch : void 0),
					);
				return {
			...
			a7 = () => Et($l, 'Build'),
			dd = () => {
				let { selectedBuild: e } = Et($l, 'Build');
			...
			Si = ({ children: e, watchState: t }) => {
				let n =
					...
					{ toggleDiff: o } = La();
				return (
					Q(() => o(l.changeCount > 0), [o, l.changeCount]),
					a.createElement(
						$l.Provider,
						{
							value: kt(
			...
			u7 = ({
				...
				a.createElement(
					...
					a.createElement(
						o7,
						null,
						t.title && a.createElement(s7, null, t.title),
						a.createElement(d7, null, t.content),
					),
				...
				(c.current !== d &&
					...
					Q(() => {
						(e.getCurrentStoryData()?.type !== 'story' &&
							...
							e.setSelectedPanel(En));
					}, [e]));
				let [m, u] = Se('showConfetti', !1),
					[p, f] = Se('stepIndex', 0),
					h = () => f((y = 0) => y + 1);
				return (
					Q(() => {
					...
					Q(() => {
						...
						return (
							...
							e.on(z1, y),
							() => {
								(e.off(To, y), e.off(z1, y));
							}
						);
					}, [e, f]),
					Q(() => {
						l?.selectedTest?.status === 'ACCEPTED' &&
							p === 5 &&
							(u(!0), f(6));
			...
			cd = ({ localBuildProgress: e, title: t }) =>
				a.createElement(
					p7,
					{ warning: !0 },
					a.createElement(
			...
			f7 = ({ children: e, localBuildProgress: t }) => (
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								'div',
								null,
								a.createElement(de, null, 'Build failed'),
								a.createElement(
									q,
									{ center: !0, muted: !0 },
							...
							a.createElement(cd, { localBuildProgress: t }),
							e,
						),
					),
				)
			),
			na = ['B', 'kB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];
		function U1(e, t) {
			let n = t?.round ?? 1;
			if (!Number.isFinite(e) || e <= 0)
				return { value: 0, symbol: na[0], exponent: 0 };
			let r = Math.min(
					na.length - 1,
					Math.max(0, Math.floor(Math.log10(e) / 3)),
				),
				i = Math.min(na.length - 1, Math.max(0, t?.exponent ?? r)),
				l = e / Math.pow(1e3, i),
				o = Math.pow(10, n),
				s = Math.round(l * o) / o,
				d = t?.exponent === void 0 && s >= 1e3 && i < na.length - 1,
				c = d ? i + 1 : i;
			return {
				value: d ? Math.round((e / Math.pow(1e3, c)) * o) / o : s,
				symbol: na[c],
				exponent: c,
			};
		}
		var rl = ['initialize', 'build', 'upload', 'verify', 'snapshot'],
			Wl = {
				initialize: {
					key: 'initialize',
					emoji: '\u{1F680}',
				...
				upload: {
					...
					renderProgress: ({ stepProgress: e }) => {
						...
						if (n == null || t == null || n <= 0)
							return 'Uploading files...';
						let { value: r, exponent: i } = U1(n, { round: 1 }),
							{ value: l, symbol: o } = U1(t, {
								exponent: i,
								round: 1,
							});
			...
			g7 = {
				...
				currentStep: rl[0],
				stepProgress: Object.fromEntries(rl.map((e) => [e, {}])),
			};
		JSON.stringify(g7);
		var ud = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
				let { emoji: r, renderProgress: i } = Wl[e.currentStep],
					l = i(e);
				return a.createElement(q, { ...n }, t && r, ' ', l);
			},
			v7 = k(q)({
				display: 'flex',
				flexDirection: 'column',
		...
		function Yr({ localBuildProgress: e }) {
			return a.createElement(
				v7,
				{ center: !0, small: !0 },
				a.createElement(
		...
		var b7 =
			...
			S7 = k.div(({ theme: e }) => ({
				...
				color: e.color.warningText,
				background: e.background.warning,
				border: `1px solid ${As(0.5, e.color.warningText)}`,
				padding: 15,
				margin: 0,
			})),
			x7 = k(q)(({ theme: e }) => ({ color: e.color.darkest })),
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								'div',
								null,
								a.createElement(de, null, 'Changes detected'),
								a.createElement(
									q,
									{ center: !0, muted: !0 },
				...
				a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(Yr, { localBuildProgress: e }),
						),
					),
				),
			F7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
				...
				n.isRunning && t
					...
					: e
						...
						: a.createElement(L7, { ...n })
			),
			T7 = k.div(({ status: e, theme: t }) => ({
				position: 'relative',
				display: 'inline-flex',
			...
			il = ({ backgroundColor: e, status: t, thumbnailUrl: n }) =>
				a.createElement(
					...
					t === 'positive' && a.createElement(Zr, null),
				),
			$1 = k(q)({ marginBottom: 5 }),
			...
			I7 = k(q)({ marginBottom: 5 }),
			O7 = ({ onCatchAChange: e, onSkip: t }) => {
			...
			Z7 = ({
				...
				let { isRunning: s, startBuild: d } = Fa(),
					[c, m] = Se('showInitialBuild', n);
				Q(() => {
					n && m(!0);
				}, [n, m]);
				let [u, p] = Se('showCatchAChange', !c),
					[f, h] = Se('initialGitHash', r.uncommittedHash),
					y = () => {
						(h(r.uncommittedHash), p(!0));
					},
					[w, b] = Se('runningSecondBuild', !1);
			...
			P7 = k(fs)({ animation: `${B7} 1s linear infinite` }),
			Ja = { width: 10, marginRight: 8 },
			G1 = k.div(({ isWarning: e, onClick: t, theme: n }) => {
			...
			Y1 = k.div(({ isWarning: e, percentage: t, theme: n }) => {
			...
			Xa = k.div({ lineHeight: '21px', padding: '4px 0' }),
			V7 = k(Lc)({ transition: 'transform 0.1s ease-in-out' }),
			H7 = k.div(({ expanded: e, theme: t }) => ({
				display: 'grid',
			...
			z7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
				let n = me({});
				Q(() => {
				...
				let r = ['aborted', 'error'].includes(e.currentStep),
					i = rl.map((l) => {
						...
						return c
							? {
									...u,
									icon: a.createElement(Qt, { style: Ja }),
									renderLabel: u.renderProgress,
								}
							: d
								? {
										...u,
										icon: a.createElement(P7, {
											style: Ja,
										}),
										renderLabel: u.renderProgress,
									}
			...
			U7 = ({
				...
				return a.createElement(
					G1,
					{ onClick: i },
					a.createElement(Y1, { percentage: 100 }),
					d(),
				);
			},
			pd = {
			...
			hd = $e(pd),
			fd = () => Et(hd, 'ReviewTest'),
			$7 = ({ children: e, watchState: t = pd }) =>
				a.createElement(hd.Provider, { value: t }, e),
			W7 = k.div(
				({ theme: e }) => ({
					position: 'relative',
					display: 'flex',
			...
			vd = ({ status: e }) => a.createElement(gd, { status: e }),
			Q7 = k.div({
				position: 'relative',
				display: 'inline-flex',
				justifyContent: 'center',
			...
			yd = ({ status: e, children: t }) =>
				a.createElement(
					Q7,
					null,
					t,
					a.createElement(gd, { overlay: !0, status: e }),
				),
			Q1 = {
				CHROME: a.createElement(b0, { alt: 'Chrome' }),
				FIREFOX: a.createElement(E0, { alt: 'Firefox' }),
				SAFARI: a.createElement(k0, { alt: 'Safari' }),
				EDGE: a.createElement(K7, { alt: 'Edge' }),
			},
			J1 = k(V.Text)({
				display: 'none',
				'@container (min-width: 300px)': { display: 'inline-block' },
			}),
			J7 = k(V.Text)(({ theme: e, active: t }) => ({
				minWidth: 80,
			...
			X7 = ({
				...
				if (
					(!e &&
						...
						n.length >= 2 &&
						(l = a.createElement(yd, { status: i }, l)),
					n.length === 1)
				)
					return a.createElement(
						V.Button,
			...
			t6 = ({
				...
				let l = Tr(n.map(({ result: d }) => d));
				if (!l) return null;
				let o = a.createElement(Sc, null);
				if (
					(!e &&
						!['EQUAL', 'SKIPPED'].includes(l) &&
						n.length >= 2 &&
						(o = a.createElement(yd, { status: l }, o)),
					n.length === 1)
				)
					return a.createElement(
						V.Button,
			...
			a6 = k.div(({ theme: e, showDivider: t }) => ({
				gridArea: 'actions',
				display: 'flex',
				alignItems: 'center',
				justifyContent: 'flex-end',
			...
			tr = k(V.Action)({ height: 'auto', flex: '0 1 100%' }),
			nr = k(V.Text)(({ theme: e }) => ({
				display: 'flex',
				flexDirection: 'column',
				alignItems: 'flex-start',
			...
			ar = k(Mr)(({ theme: e, side: t, status: n }) => ({
				...(n === 'positive' && {
					backgroundColor: e.background.positive,
					border: `1px solid ${As(0.35, e.color.positive)}`,
					color: e.color.positiveText,
					'&:hover': {
						backgroundColor: Ri(0.05, e.background.positive),
					},
				}),
				...(t === 'left' && {
					borderTopRightRadius: 0,
			...
			r6 = ({ isOutdated: e }) => {
				let {
					...
					{ isRunning: s, startBuild: d } = Fa(),
					{
						selectedTest: c,
						selectedComparison: m,
						summary: u,
					} = rn(),
						...
						a.createElement(
							...
							!(w && y) &&
								a.createElement(
									...
									{
										readOnly: !0,
										tooltip: 'Reviewing disabled',
									},
									a.createElement(Ec, null),
								),
							a.createElement(
								Mr,
								{
			...
			l6 = ({ icon: e }) => {
				let { color: t } = un();
				return {
					passed: a.createElement(yc, {
						style: { ...Ai, color: t.positive },
					}),
					changed: a.createElement(bc, {
						style: { ...Ai, color: t.warning },
					}),
					failed: a.createElement(Qt, {
						style: { ...Ai, color: t.negative },
					}),
				}[e];
			};
		function ll(e) {
		...
		var f6 = {
			...
			y6 = {
				date: Li({ formats: f6, defaultWidth: 'full' }),
				time: Li({ formats: g6, defaultWidth: 'full' }),
				dateTime: Li({ formats: v6, defaultWidth: 'full' }),
			},
			b6 = y6,
			E6 = {
		...
		var C6 = {
			...
			T6 = {
				ordinalNumber: F6,
				era: aa({ values: C6, defaultWidth: 'wide' }),
				quarter: aa({
					values: S6,
					defaultWidth: 'wide',
				...
				month: aa({ values: x6, defaultWidth: 'wide' }),
				day: aa({ values: A6, defaultWidth: 'wide' }),
				dayPeriod: aa({
					values: L6,
					defaultWidth: 'wide',
					formattingValues: N6,
		...
		function J6(e, t, n) {
			...
			var c = Ed(Q6(n), { addSuffix: !!n?.addSuffix, comparison: d }),
				m,
				u;
			d > 0 ? ((m = Gt(t)), (u = Gt(e))) : ((m = Gt(e)), (u = Gt(t)));
			var p = String(
					(l = n?.roundingMethod) !== null && l !== void 0
						? l
						: 'round',
				),
				f;
			...
			if (
				...
				var L = f(y / 60);
				return s.formatDistance('xHours', L, c);
			} else if (v === 'day') {
				var N = f(b / Ir);
				...
				return G === 12 && g !== 'month'
					...
					: s.formatDistance('xMonths', G, c);
			} else if (v === 'year') {
				var te = f(b / is);
				return s.formatDistance('xYears', te, c);
			}
			throw new RangeError(
		...
		function X6(e, t) {
			return (Ba(1, arguments), J6(e, Date.now(), t));
		}
		var ef = {
		...
		function tf(e, t, n = { addSuffix: !1, comparison: 0 }) {
			let r = ef[e].replace('{{count}}', t);
		...
		var kd = (e) =>
				X6(e, { addSuffix: !0, locale: { ...bd, formatDistance: tf } }),
			ia = k.div(({ theme: e }) => ({
				gridArea: 'info',
				display: 'flex',
				justifySelf: 'start',
											...
											a.createElement(
												...
												a.createElement(
													...
													p
														? null
														: u
															? `${(0, rr.default)('change', u, !0)}${c === 'ACCEPTED' ? ' accepted' : ''}`
															: 'No changes',
													p
														? (0, rr.default)(
																'error',
  ...
  `,
			...
			sf = ({
				...
				let {
					...
					{ toggleBaselineImage: m } = La(),
					u = dd(),
					p = 'startedAt' in u && u.startedAt,
					f = rn(),
					{ tests: h } = f,
					y = a.useRef(o),
					w = a.useRef(f.selectedComparison?.id),
					b = a.useRef(u.id),
					{ selectedTest: g, selectedComparison: v } = f,
					E = h.every(
						({ result: ke, status: je }) =>
							ke === 'ADDED' && je !== 'ACCEPTED',
					),
					S = !E && g?.result === 'ADDED' && g?.status !== 'ACCEPTED',
					L =
						!E &&
						v?.result === 'ADDED' &&
						g?.result !== 'ADDED' &&
				...
				Q(() => {
					((y.current !== o ||
						w.current !== f.selectedComparison?.id ||
						b.current !== u.id ||
						E ||
						S ||
						L) &&
				...
				if (t || !h.length)
					return a.createElement(
						os,
						{ hidden: l },
						a.createElement(ss, null, a.createElement(ls, null, N)),
						a.createElement(ds, null, a.createElement(es, null)),
					);
				let G = Ul(h),
					{ isInProgress: te } = G,
					fe =
						v?.headCapture?.captureError &&
						'error' in v?.headCapture?.captureError &&
						v?.headCapture?.captureError?.error;
				return a.createElement(
					os,
					{ hidden: l },
					a.createElement(
						...
						a.createElement(
							...
							null,
							N,
							a.createElement(r6, { isOutdated: e }),
						),
					),
					a.createElement(
						rf,
						null,
						te && a.createElement(ni, null),
						!te &&
							E &&
							a.createElement(
								Ni,
						...
						!te &&
							...
							a.createElement(Y7, {
								key: v.id,
								componentName: g?.story?.component?.name,
								storyName: g?.story?.name,
								testUrl: g?.webUrl,
								comparisonResult: v.result ?? void 0,
								latestImage:
									v.headCapture?.captureImage ?? void 0,
								baselineImage:
									v.baseCapture?.captureImage ?? void 0,
								baselineImageVisible: s,
								diffImage: v.captureDiff?.diffImage ?? void 0,
								focusImage: v.captureDiff?.focusImage ?? void 0,
								diffVisible: d,
								focusVisible: c,
							}),
						!te &&
		...
		var df = ({
				...
				let { isRunning: o, startBuild: s, stopBuild: d } = Fa(),
					{
						lastBuildOnBranch: c,
					...
					p = dd(),
					f = rn(),
					{ buildIsReviewable: h, userCanReview: y } = fd(),
					w = !!(!h && m && u && i),
					...
					E =
						...
						a.createElement(U7, {
							branch: e,
							dismissBuildError: t,
							localBuildProgress: v || o ? r : void 0,
							lastBuildOnBranchInProgress: b,
							switchToLastBuildOnBranch: i,
						}),
					S = f?.hasTests && f?.tests.length === 0,
					L = p.id !== `Build:${r?.buildId}`;
				if (S)
					return a.createElement(
						he,
						null,
				...
				if (f?.tests?.find((ke) => ke.result === 'SKIPPED'))
					return a.createElement(
						he,
						null,
						E,
				...
				let { status: N } = p,
					G = ['ANNOUNCED', 'PUBLISHED', 'PREPARED'].includes(N),
					te = N === 'FAILED',
					fe = N === 'PENDING' && (!y || !h);
				return a.createElement(
					he,
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(sf, {
								...
								isStarting: G,
								isBuildFailed: te,
								shouldSwitchToLastBuildOnBranch: w,
								switchToLastBuildOnBranch: i,
								selectedBuild: p,
								storyId: l,
							}),
					...
					p = () => {
						...
						return i
							? i.currentStep === 'error'
								...
								: a.createElement(Yr, { localBuildProgress: i })
							: f;
					};
				return a.createElement(
					he,
			...
			uf = ({
				...
				let [{ fetching: i }, l] = p0(t7),
					...
					s = z(
						(c, m = 'SPEC') =>
							o({ status: 'ACCEPTED', testId: c, batch: m }),
						[o],
					),
					d = z(
						(c, m = 'SPEC') =>
							o({ status: 'PENDING', testId: c, batch: m }),
						[o],
					);
				return {
					isReviewing: i,
...
`),
			pf = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
				let n = Ft(),
					{ notifications: r, storyId: i } = Wn(),
					[l, o] = a.useState(!1),
					s = a.useCallback(() => {
						(o(!0),
							r.forEach(({ id: g }) => n.clearNotification(g)));
					}, [n, r]),
					[d, c] = a.useState(!1),
					m = a.useCallback(() => c(!0), []),
					[u, p] = a.useState(!0);
			...
			hf = ({
				...
				let d = Ft(),
					{ addNotification: c, setOptions: m, togglePanel: u } = d,
					p = n7({
						projectId: l,
						storyId: s,
						gitInfo: o,
					...
					}),
					{
						...
						hasSelectedBuild: g,
						lastBuildOnBranch: v,
						lastBuildOnBranchIsReady: E,
						lastBuildOnBranchIsSelectable: S,
						selectedBuild: L,
						queryError: N,
						rerunQuery: G,
						userCanReview: te,
					...
					fe = z(
						({ onDismiss: on }) => {
							(on(), m({ selectedPanel: En }), u(!0));
						},
						[m, u],
					),
					ke = uf({
						buildIsReviewable: !!L && L.id === v?.id,
						userCanReview: te,
						onReviewSuccess: G,
						onReviewError: (on, Td) => {
							on instanceof Error &&
								c({
									id: `${j}/errorAccepting/${Date.now()}`,
									content: {
										headline: `Failed to ${Td.status === 'ACCEPTED' ? 'accept' : 'unaccept'} changes`,
										subHeadline: on.message,
									},
					...
					je =
						v &&
						'testsForStatus' in v &&
						v.testsForStatus?.nodes &&
						bn(od, v.testsForStatus.nodes),
					Ae = S ? wp(je || []) : [];
				(Q(() => {
					i(Ae);
				}, [JSON.stringify(Ae), i]),
					Q(() => {
						t((on) =>
							Cp(on, {
								shouldSwitchToLastBuildOnBranch: S && E,
								lastBuildOnBranchId: v?.id,
								storyId: s,
							}),
						);
					}, [S, E, v?.id, t, s]));
				let ye = z(
						() => v?.id && S && t({ buildId: v.id, storyId: s }),
						[t, S, v?.id, s],
					),
					{
						showOnboarding: Le,
						showGuidedTour: Vt,
						completeOnboarding: Ke,
						completeWalkthrough: _e,
						skipOnboarding: Qr,
						skipWalkthrough: ze,
						startWalkthrough: Nd,
						lastBuildHasChangesForStory: Fd,
					} = pf(p);
				return h && !h.uiTests
					? a.createElement(Sp, { manageUrl: y })
					: f?.suspensionReason
						? a.createElement(S0, {
								billingUrl: f.billingUrl,
			...
			ff = (e) => {
				let [t, n] = Se('selectedBuildInfo');
				return a.createElement(hf, {
					selectedBuildInfo: t,
					setSelectedBuildInfo: n,
					...e,
				});
			},
			wd = ({ localBuildProgress: e, accessToken: t }) => {
				let n = $n({}),
					r = sn(Br),
					[i, l] = be(!1),
					[o, s] = be(!1),
			...
			gf = () => {
				let e = $n({
					[qc]: (t) => {
						let n = hn.get(t.requestId);
						if (n)
							if ((hn.delete(t.requestId), 'error' in t))
				...
				return async (t, { signal: n, ...r } = {}) => {
					...
					return (
						n?.addEventListener('abort', () => {
							(e($c, { requestId: i }),
								hn.get(i)?.reject(n.reason),
								hn.delete(i));
						}),
						e(Wc, { requestId: i, input: t, init: r }),
						new Promise((l, o) => {
							(hn.set(i, { resolve: l, reject: o }),
								setTimeout(() => {
			...
			vf = ({ active: e }) => {
				...
				Q(() => {
					let ze = () => {
						t.addNotification({
							id: `${j}/error/session-expired/${Date.now()}`,
							content: {
					...
					return (
						window.addEventListener(o1, ze),
						() => {
							window.removeEventListener(o1, ze);
						}
					);
				}, [t]);
				let h = z((ze) => {
					...
					}, []),
					{
						...
						configFile: b,
						updateProject: g,
						projectUpdatingFailed: v,
						projectIdUpdated: E,
						clearProjectIdUpdated: S,
					} = Cd(),
					[L, N] = Se('createdProjectId'),
					[G, te] = Ee(ks),
					[fe, ke] = Se('subdomain', 'www'),
					je = z((ze) => f(Es, ze), [f]),
					{
						isRunning: Ae,
						startBuild: ye,
						stopBuild: Le,
					} = wd({ localBuildProgress: u, accessToken: n }),
					Vt = gf(),
					Ke =
						globalThis.LOGLEVEL === 'debug' ? globalThis.fetch : Vt,
					_e = (ze) =>
						a.createElement(
							V4,
							{ value: y0({ fetch: Ke }) },
				...
				if (globalThis.CONFIG_TYPE !== 'DEVELOPMENT')
					return _e(a.createElement(vp, null));
				if (G) return _e(a.createElement(bp, null));
				if (m) return _e(a.createElement(yp, { offline: m }));
				if (!n)
					return _e(
						a.createElement(Q4, {
							setAccessToken: l,
							setCreatedProjectId: N,
							hasProjectId: !!w,
						}),
					);
				if (c || !d)
					return _e(a.createElement(np, { gitInfoError: c }));
				if (y) return e ? a.createElement(Bi, null) : null;
				if (!w)
					return _e(
						a.createElement(pp, {
							createdProjectId: L,
				...
				if (v) {
					...
					return _e(
						a.createElement(cp, { projectId: w, configFile: b }),
					);
				}
				if (E) {
					if (!b)
				...
				let Qr = d.branch === u?.branch;
				return _e(
					a.createElement(ff, {
						dismissBuildError: () => p(void 0),
						localBuildProgress: Qr ? u : void 0,
						updateBuildStatus: h,
						projectId: w,
						gitInfo: d,
						storyId: s,
		...
		function bf(e, t, n, r) {
			if (
				(t.shareRequestId !== e.shareRequestId &&
					e.shareRequestId === null &&
					t.shareRequestId &&
					(t.status === 'pending' || t.status === 'uploading'
						? (e = {
								...e,
								shareRequestId: t.shareRequestId,
								shareTriggeredId: t.shareRequestId,
								screen: {
									status: 'uploading',
									shareUrl:
										t.status === 'uploading'
				...
				return { next: e, effect: { kind: 'none' } };
			if (
				t.status === 'uploading' &&
				t.shareUrl &&
				e.screen.status === 'uploading' &&
				t.shareUrl !== e.screen.shareUrl
			)
				return {
					next: {
						...e,
						screen: { status: 'uploading', shareUrl: t.shareUrl },
					},
					effect: { kind: 'url-received' },
				};
			if (t.status === 'complete') {
				let { shareUrl: i, daysToExpire: l } = t;
				return {
					next: {
						...e,
						screen: {
			...
			return t.status === 'error'
				? t.canceled
					...
					: /\b(401|403|unauthorized|expired)\b/i.test(t.error)
						? {
								next: {
									...e,
									screen: { status: 'idle' },
		...
		function Ef(e, t) {
			switch (t.type) {
				...
				case 'PUBLISH_REQUESTED':
					return t.hasToken
						? {
								...
								shareRequestId: t.newRequestId,
								shareTriggeredId: null,
							}
						: { ...e, screen: { status: 'idle' } };
				case 'PUBLISH_AGAIN':
					return {
						...e,
						screen: { status: 'uploading', shareUrl: '' },
				...
				case 'GO_SUBDOMAIN':
					return { ...e, screen: { status: 'subdomain' } };
				case 'BACK_TO_IDLE':
					return { ...e, screen: { status: 'idle' } };
		...
		var Hn = k.div({
			...
			jn = k.div({ display: 'flex', flexDirection: 'column' }),
			Kr = k.div({
				display: 'flex',
				flexDirection: 'column',
				alignItems: 'flex-start',
			...
			Cf = k(Ad)(({ theme: e }) => ({ color: e.textMutedColor })),
			Sf = k(jt)({ margin: 1 }),
			Ld = ({ url: e, placeholder: t, onCopy: n }) => {
				let [r, i] = be(!1),
					l = me();
				Q(
					() => () => {
					...
					if (e)
						try {
							(await navigator.clipboard.writeText(e),
								...
								i(!0),
								l.current && clearTimeout(l.current),
								(l.current = setTimeout(() => i(!1), 2e3)));
						} catch (s) {
							console.warn('Failed to copy to clipboard:', s);
						}
				}, [e, n]);
				return a.createElement(
					kf,
					...
					e &&
						a.createElement(
							...
							a.createElement(
								...
								r
									? a.createElement(Zr, { color: 'green' })
			...
			zn = () => {
				...
				return a.createElement(
					xf,
					null,
					a.createElement(ln, { as: 'h3' }, 'Who has access'),
					a.createElement(
						Af,
						null,
						a.createElement(Mc, {
						...
						a.createElement(Lf, null, 'Anyone with the link'),
						a.createElement(
							Nf,
							{
					...
					a.createElement(
						...
						a.createElement(
							...
							a.createElement(
								ln,
								null,
								'Copy link to published Storybook',
							),
							a.createElement(
								Dn,
								null,
						...
						a.createElement(
							Kr,
							null,
							a.createElement(Ld, { url: e, onCopy: l }),
							!r && o
								? a.createElement(
										Ff,
										null,
										...
										a.createElement(
											...
											n !== void 0
												? (() => {
														...
														return ` \u2013 expires in ${c} ${c === 1 ? 'day' : 'days'}`;
													})()
												: '',
										),
									),
			...
			Rf = k(Xl)({ padding: '4px 8px', margin: '0 6px' }),
			Bf = k(xd)({ alignItems: 'baseline' }),
			Pf = k(Rf)({ margin: 0, flexShrink: 0 }),
			Vf = k.span(({ theme: e }) => ({
				color: e.color.defaultText,
				fontSize: e.typography.size.s1,
				lineHeight: '16px',
			...
			Df = ({ reason: e, message: t, onRetry: n }) => {
				let r = e === 'unknown' && t ? t : Hf[e];
				return a.createElement(
					Hn,
					null,
					a.createElement(
						jn,
						null,
						a.createElement(ln, null, 'Publish a build to share'),
						a.createElement(
							Dn,
							null,
					...
					a.createElement(
						...
						a.createElement(
							re,
							{ size: 'medium', variant: 'solid', onClick: n },
							'Publish & copy link',
						),
						a.createElement(
							Bf,
			...
			jf = ({ onSignIn: e, onSignInWithSSO: t }) =>
				a.createElement(
					Hn,
					null,
					a.createElement(
						jn,
						null,
						a.createElement(ln, null, 'Publish and share builds'),
						a.createElement(
							Dn,
							null,
							'This Storybook will be uploaded and available to collaborators for feedback.',
					...
					a.createElement(
						...
						a.createElement(
							re,
							{ size: 'medium', variant: 'solid', onClick: e },
							'Sign in with Chromatic',
						),
						a.createElement(
							Sd,
			...
			$f = k(Hn)({ position: 'relative', paddingTop: 42 }),
			Wf = k(re)({ position: 'absolute', top: 6, left: 6 }),
			qf = ({ onSubmit: e, onBack: t }) => {
				let [n, r] = be(''),
					[i, l] = be(null),
					o = z((d) => {
						(r(wl(d.target.value)), l(null));
					...
					s = z(
						(d) => {
							d.preventDefault();
							let c = zs(n);
							c ? e(c) : l('Please enter a subdomain');
						},
						[n, e],
					);
				return a.createElement(
					...
					a.createElement(
						Wf,
						{ variant: 'ghost', onClick: t, 'aria-label': 'Back' },
						a.createElement(hs, {
							size: 12,
							'aria-hidden': 'true',
						}),
					...
					a.createElement(
						jn,
						null,
						a.createElement(ln, null, 'Sign in with SSO'),
						a.createElement(
							Dn,
							null,
							"Enter your team's Chromatic subdomain.",
						),
					),
					a.createElement(
						zf,
			...
			Yf = ({
				...
				return a.createElement(
					...
					a.createElement(
						jn,
						null,
						a.createElement(ln, null, 'Publishing\u2026'),
						a.createElement(
							Dn,
							null,
					...
					a.createElement(
						Kr,
						null,
						a.createElement(Ld, { url: e || void 0, onCopy: n }),
						a.createElement(
							xd,
							{ 'aria-live': 'polite' },
							a.createElement(hc, {
		...
		function Qf(e) {
			let [, t] = zr(),
				{ begin: n } = f0({
					onAuthenticated: (r, { closeDialog: i }) => {
						(Yi(r), i(), e({ status: 'uploading', shareUrl: '' }));
					},
					onError: () => {
						e({ status: 'error', reason: 'unknown' });
					},
				});
			return {
				startSignIn: z(
		...
		function Jf({
			...
			shareProgress: r,
			gitInfo: i,
			lastCompletedShareUrl: l,
			setLastCompletedShareUrl: o,
			setLastCompletedGitInfo: s,
			updateToken: d,
			dispatch: c,
		}) {
			let m = me(!1),
				u = me(n.screen.status),
				p = me(!1),
				f = z(
					(L, N) => {
						e.getChannel()?.emit(Es, {
							action: L,
							entryPoint: 'toolbar',
							...N,
						});
				...
				h = r?.status === 'pending' || r?.status === 'uploading';
			Q(() => {
				let L =
					n.screen.status === 'welcome' ||
					n.screen.status === 'idle' ||
					n.screen.status === 'subdomain';
				t &&
					L &&
					!h &&
					c({
						type: 'AUTO_SKIP_TO_UPLOADING',
						newRequestId: crypto.randomUUID(),
					});
			}, [t, n.screen.status, h, c]);
			let y = n.screen.status,
				{ shareRequestId: w, shareTriggeredId: b } = n;
			(Q(() => {
				if (
					y !== 'uploading' ||
					!t ||
					h ||
					(b && b === w) ||
					(r?.shareRequestId === w && r?.status === 'complete')
				)
					return;
				let L = w ?? crypto.randomUUID();
				(c({ type: 'START_SHARE_EMITTED', id: L }),
					e
						.getChannel()
						?.emit(Bc, { accessToken: t, shareRequestId: L }),
					f('share-initiated', { isRepeatShare: m.current }),
					(m.current = !1));
			}, [e, c, f, y, w, b, r, h, t]),
				Q(() => {
					(u.current === 'idle' &&
						n.screen.status === 'uploading' &&
						f('share-auth-completed'),
						(u.current = n.screen.status));
				}, [f, n.screen.status]));
			let g = me({
				reducerState: n,
				gitInfo: i,
				...
				Q(() => {
					...
					let L = g.current,
						{ next: N, effect: G } = bf(
							...
							r,
							L.gitInfo,
							L.lastCompletedShareUrl,
						);
					switch (
						(N !== L.reducerState &&
							L.dispatch({ type: 'APPLY_STATE', next: N }),
						G.kind)
					) {
						case 'url-received':
							L.emitTelemetry('share-url-received');
							break;
						case 'completed':
							((p.current = !1),
								G.isNew &&
									(L.setLastCompletedShareUrl(G.shareUrl),
									L.setLastCompletedGitInfo(G.gitInfo),
									L.emitTelemetry('share-upload-completed')));
							break;
						case 'auth-error':
							p.current
								? ((p.current = !1),
									L.updateToken(null),
									L.emitTelemetry('share-failed'))
								: ((p.current = !0),
									L.emitTelemetry('share-auth-retry'),
									vt.refresh().catch(() => {}));
							break;
						case 'failed':
							((p.current = !1), L.emitTelemetry('share-failed'));
							break;
					}
				}, [r]));
			let v = z(() => {
					(e
						.getChannel()
						?.emit(Pc, { shareRequestId: n.shareRequestId }),
						f('share-canceled'));
				}, [e, f, n.shareRequestId]),
				E = z(() => {
					((p.current = !1),
						c({
		...
		var ol = !1,
			...
			e8 = ({ api: e }) => {
				let [t] = zr(),
					[n] = Ee(hl),
					[r] = Ee(fl),
					[i, l] = Se('shareReducer', yf),
					[o, s] = ei(Ef, i),
					[d, c] = Se('shareLastCompletedUrl', null),
					[m, u] = Se('shareLastCompletedGitInfo', void 0);
				(Q(() => {
					l(o);
				}, [o, l]),
					Q(
				...
				let p = z((E) => s({ type: 'SET_SCREEN', screen: E }), []),
					{ startSignIn: f, updateToken: h } = Qf(p),
					{
						emitTelemetry: y,
						handleCancel: w,
						handlePublish: b,
						handlePublishAgain: g,
					} = Jf({
						api: e,
						token: t,
						reducerState: o,
						shareProgress: r,
						gitInfo: n,
						lastCompletedShareUrl: d,
						setLastCompletedShareUrl: c,
						setLastCompletedGitInfo: u,
						updateToken: h,
						dispatch: s,
					}),
					v = o.screen;
				switch (v.status) {
					case 'welcome':
						return a.createElement(Kf, { onPublish: b });
					case 'idle':
						return a.createElement(jf, {
							onSignIn: () => f(),
							onSignInWithSSO: () => s({ type: 'GO_SUBDOMAIN' }),
						});
					case 'subdomain':
						return a.createElement(qf, {
							onSubmit: (E) => f(E),
							onBack: () => s({ type: 'BACK_TO_IDLE' }),
						});
					case 'uploading':
						return a.createElement(Yf, {
							shareUrl: v.shareUrl,
							step: r?.status,
							onCopy: () => y('share-url-copied'),
							onCancel: w,
						});
					case 'complete':
						return a.createElement(Zf, {
							shareUrl: v.shareUrl,
			...
			t8 = ({ api: e }) =>
				a.createElement(
					Ut,
					{
						...
						placement: 'bottom',
						padding: 0,
						popover: a.createElement(e8, { api: e }),
					},
					a.createElement(
						jt,
						{
			...
			r8 = k.div({ display: 'flex', gap: 4 }),
			i8 = k.div(({ crashed: e, theme: t }) => ({
				fontSize: t.typography.size.s1,
			...
			d8 = () => {
				let {
					...
					i = Gl(
						(ye) =>
							Object.values(ye)
								.map((Le) => Le[j]?.value)
								.filter((Le) => Le === 'status-value:warning')
								.length,
					),
					l = sn(Br),
					{ projectId: o } = Cd(),
					...
					[u] = Ee(bs),
					[p] = Ee(pl),
					f = Object.keys(p?.problems || {}).length > 0,
					[h] = Ee(hl),
					[y] = Ee(gs),
					w = me(u?.currentStep),
					{ index: b, storyId: g, viewMode: v } = Wn(),
					E = Yl((ye) => ye[Mi] ?? 'test-provider-state:pending'),
					{ startBuild: S, stopBuild: L } = wd({
						localBuildProgress: u,
						accessToken: s,
					}),
					N;
				(c && (N = 'Not available offline'),
					f && (N = 'Configuration problem'),
					y && (N = 'Git synchronization problem'),
					d || (N = 'Login required'),
					o || (N = 'Set up visual tests'));
				let G = !N && E !== 'test-provider-state:crashed',
					te = z(() => {
						G && S();
					}, [G, S]);
				Q(() => ql(Mi).onRunAll(te), [te]);
				let fe = z(
						(ye) => {
							if (
								(n({ selectedPanel: En }),
								...
								let Le = Object.keys(b).indexOf(g),
									Vt = Object.entries(b).slice(
										Le > 0 ? Le : 0,
									),
									[Ke] =
										Vt.find(
							...
							ye && l?.({ action: 'openWarning', warning: ye });
						},
						[n, r, l, b, t, g, v],
					),
					ke = z(
				...
				(Q(() => {
					let ye = () => m(!0),
						Le = () => m(!1);
					return (
						window.addEventListener('offline', ye),
						window.addEventListener('online', Le),
						() => {
							(window.removeEventListener('offline', ye),
								window.removeEventListener('online', Le));
						}
					);
				}, [m]),
					Q(() => {
						u?.currentStep !== w.current &&
							((w.current = u?.currentStep),
							u?.currentStep === 'error' &&
								e({
									id: `${j}/build-error/${Date.now()}`,
									content: {
							...
							u?.currentStep === 'limited' &&
								e({
									id: `${j}/build-limited/${Date.now()}`,
									content: {
				...
				switch (!0) {
					case !!N:
						Ae = a.createElement(zt, { onClick: je }, N);
						break;
					case E === 'test-provider-state:running':
						Ae = u
							? Wl[u.currentStep].renderProgress(u)
							: 'Starting...';
						break;
					case Zl(u, h):
						Ae = 'Test results outdated';
						break;
					case u?.currentStep === 'aborted':
						Ae = 'Aborted by user';
						break;
					case u?.currentStep === 'complete':
						Ae = u.errorCount
							? `Encountered ${(0, Ti.default)('component error', u.errorCount, !0)}`
							: i
								? `Found ${(0, Ti.default)('story', i, !0)} with ${(0, Ti.default)('change', i)}`
							...
							: E === 'test-provider-state:running'
								? a.createElement(
										...
										a.createElement(
											...
											{
												percentage:
													u?.buildProgressPercentage,
											},
											a.createElement(s8, null),
										),
									)
								: a.createElement(
										jt,
		...
		if (window.opener && !window.opener.closed) {
			...
			if (t && n)
				(window.opener.postMessage(
					{ message: 'grant', code: t, state: n },
					window.location.origin,
				),
					window.close());
			else if (r && n) {
				let i = e.get('error_description');
				(window.opener.postMessage(
					{
						message: 'grant',
						error: r,
						state: n,
						...(i ? { error_description: i } : {}),
					},
					window.location.origin,
				),
					window.close());
		...
		dn.register(j, (e) => {
			(e.on(zc, (r, i) => {
				let l = Uc.includes(i.selectors[0]);
				window.open(
					l
				...
				dn.add(`${j}/ignore-highlight-tool`, {
					type: Un.TOOL,
					title: 'Highlight ignored areas',
					match: ({ viewMode: r }) => r === 'story',
					render: () => a.createElement(Kc, null),
				}),
				dn.add(En, {
					type: Un.PANEL,
					title: 'Visual tests',
					...
					match: ({ viewMode: r }) => r === 'story',
					render: ({ active: r }) =>
						a.createElement(vf, { active: !!r }),
				}));
			let t = e.getChannel();
			if (t) {
				let r = null;
				Sl.subscribe(fl, t).on('change', (i) => {
					if (i?.status !== 'complete' || i.shareUrl === r || Xf())
						return;
					let { shareUrl: l } = i;
					((r = l),
						e.addNotification({
							id: `${j}/share-published`,
							content: {
			...
			let n = Pa(j);
			(n.onSelect(() => {
				(e.setSelectedPanel(En), e.togglePanel(!0));
			}),
				dn.add(Mi, {
					type: Un.experimental_TEST_PROVIDER,
					clear: () => {
						n.unset();
					},
					render: () => a.createElement(d8, null),
				}),
				dn.add(`${j}/share-tool`, {
					type: Un.TOOLEXTRA,
					title: 'Share',
					render: () => a.createElement(t8, { api: e }),
				}));
		});
	})();
} catch (e) {
